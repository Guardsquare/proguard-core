...
import dexir.ET;
import dexir.LabelAndLocalMapper;
...
public abstract class Value implements Cloneable {
    ...
    public enum VT {
        ...
        FCMPL(MAY_THROW),
        FIELD(CAN_THROW),
        FILLED_ARRAY(CAN_THROW),
        GE(">=", MAY_THROW),
        GT(">", MAY_THROW),
        INSTANCE_OF(CAN_THROW),
        INVOKE_INTERFACE(CAN_THROW),
        INVOKE_NEW(CAN_THROW),
        INVOKE_SPECIAL(CAN_THROW),
        INVOKE_STATIC(CAN_THROW),
        INVOKE_VIRTUAL(CAN_THROW),
        INVOKE_CUSTOM(CAN_THROW),
        INVOKE_POLYMORPHIC(CAN_THROW),
        LCMP(MAY_THROW),
        LE("<=", MAY_THROW),
        LENGTH(CAN_THROW),
        LOCAL(0),
