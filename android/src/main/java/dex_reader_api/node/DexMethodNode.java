 ...
 */
package dex_reader_api.node;

import dex_reader_api.Method;
import dex_reader_api.Visibility;
...
public class DexMethodNode extends DexMethodVisitor {
    ...
    public DexAnnotationAble visitParameterAnnotation(final int index) {
        ...
        if (index >= parameterAnns.length) {
            System.err.println("Warning, ignoring parameter annotations for out of range parameter index " + index +
                    " in: " + method);
            return null;
        }
