...
import dex_ir.stmt.Stmts;
import dex_ir.ts.Cfg;
import dex_ir.ts.StatedTransformer;
import dex_ir.ts.UniqueQueue;
...
public class FillArrayTransformer extends StatedTransformer {
    ...
    private void makeSureArrayUsedAfterAllElementAssigned(IrMethod method, final Map<Local, ArrayObject> arraySizes) {
        ...
        if (arraySizes.size() < MAX) {
            ...
            // it
            Map<Local, ArrayObject> keptInAll = new LinkedHashMap<>();
            Map<Local, ArrayObject> keptInPart = new LinkedHashMap<>();
    ...
    private Map<Local, ArrayObject> searchForArrayObject(IrMethod method) {
        ...
        final Map<Local, ArrayObject> arraySizes = new LinkedHashMap<>();
