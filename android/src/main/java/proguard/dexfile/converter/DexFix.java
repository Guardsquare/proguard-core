 ...
 *
 * <p>2. static-final field init by zero, but assigned in clinit
 *
 * <p>this method is try to fix the problems.
 */
public class DexFix {
   ...
   * method
   *
   * <p>erase the default value if the field is init in clinit method
   *
   * @param classNode
   */
