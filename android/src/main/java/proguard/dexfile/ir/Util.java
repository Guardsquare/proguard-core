...
public class Util {
  ...
  public static long irTransformMemoryLimit =
      Long.parseLong(System.getProperty("dex2pro.ir.transform.memory.limit", "0")) * 1024L * 1024L;
  ...
  public static boolean isMemoryLimitReached(long afterMemoryQuota) {
    ...
    return heapMemoryUsage.getMax() - heapMemoryUsage.getUsed() < afterMemoryQuota;
  }
}
