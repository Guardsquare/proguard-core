...
public final class Exprs {
  ...
  public static FieldExpr nField(
      Value object, String ownerType, String fieldName, String fieldType) {
  ...
  public static InvokeExpr nInvokeInterface(
      Value[] regs, String owner, String name, String[] argmentTypes, String returnType) {
  ...
  public static InvokeExpr nInvokeNew(
      Value[] regs, String[] argmentTypes, String owner, String className) {
    return new InvokeNewExpr(
        Value.VT.INVOKE_NEW, regs, owner, "<init>", argmentTypes, owner, className);
  }

  public static InvokeExpr nInvokeSpecial(
      Value[] regs, String owner, String name, String[] argmentTypes, String returnType) {
    return new InvokeExpr(Value.VT.INVOKE_SPECIAL, regs, owner, name, argmentTypes, returnType);
  }

  public static InvokeExpr nInvokeStatic(
      Value[] regs, String owner, String name, String[] argmentTypes, String returnType) {
    return new InvokeExpr(Value.VT.INVOKE_STATIC, regs, owner, name, argmentTypes, returnType);
  }

  public static InvokeExpr nInvokeVirtual(
      Value[] regs, String owner, String name, String[] argmentTypes, String returnType) {
    return new InvokeExpr(Value.VT.INVOKE_VIRTUAL, regs, owner, name, argmentTypes, returnType);
  }

  public static InvokeCustomExpr nInvokeCustom(
      Value[] regs, String name, Proto proto, MethodHandle handle, Object[] bsmArgs) {
