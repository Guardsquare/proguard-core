...
/**
 * Represent a method invocation expression. To represent a {@link VT#INVOKE_INTERFACE},{@link
 * VT#INVOKE_SPECIAL} or {@link VT#INVOKE_VIRTUAL} the first element of ops is the owner object,To
 * represent a {@link VT#INVOKE_NEW} or {@link VT#INVOKE_STATIC} all ops are arguments. The return
 * type of {@link VT#INVOKE_NEW} is owner instead of ret
 *
...
public class InvokeExpr extends AbstractInvokeExpr {
  ...
  public String toString0() {
    ...
    if (vt == VT.INVOKE_NEW) {
      ...
      sb.append(Util.toShortClassName(getOwner())).append('.').append(getName());
    } else {
