...
import proguard.dexfile.ir.expr.RefExpr;
import proguard.dexfile.ir.expr.Value;
import proguard.dexfile.ir.stmt.Stmt;
import proguard.dexfile.ir.ts.an.SimpleLiveAnalyze;
import proguard.dexfile.ir.ts.an.SimpleLiveValue;

/**
 *
 *
 * <ol>
 *   <li>Share same reg between locals with same type.
 *   <li>@This always assign as 0, and not share with others.
 *   <li>long/double tasks two index
 * </ol>
 *
 * @author bob
 */
public class Ir2JRegAssignTransformer implements Transformer {
  ...
  private static final Comparator<Reg> OrderRegAssignByPreferredSizeDesc =
      new Comparator<Reg>() {
