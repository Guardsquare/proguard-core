 ...
 * </pre>
 *
 * <p>2. Remove Phi if all value are equal
 *
 * <pre>
 * a = &quot;123&quot;;
 * // ...
...
public class RemoveConstantFromSSA extends StatedTransformer {
  ...
  public static final Comparator<Local> LOCAL_COMPARATOR =
      Comparator.comparingInt(local -> local._ls_index);
  ...
  /**
   * Don't inline any constants for locals used by a lock. If converted back to dex, this may cause
   * a VerifyError as new throwing instructions could be added without being guarded by a catch-all.
