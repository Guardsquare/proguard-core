...
public class AndroidConstants {
  ...
  public static final String AAB_OBFUSCATION_PREFIX =
      "BUNDLE-METADATA/com.android.tools.build.obfuscation/";
  public static final String AAB_BUNDLETOOL_PREFIX =
  ...
  public static final String AAB_RESOURCES_EXPRESSION =
      AAB_RESOURCES_PB_EXPRESSION + ',' + AAB_RESOURCES_ARSC_EXPRESSION;
  public static final String AAB_XML_FILE_EXPRESSION =
      AAB_ANDROID_MANIFEST_XML_EXPRESSION + ',' + AAB_RES_XML_FILE_EXPRESSION;
  ...
  public static final String ANDROID_MANIFEST_XML_EXPRESSION =
      ANDROID_MANIFEST_XML + ',' + AAB_ANDROID_MANIFEST_XML_EXPRESSION;
  public static final String BASE_ANDROID_MANIFEST_XML_EXPRESSION =
      ANDROID_MANIFEST_XML + ',' + AAB_BASE + AAB_ANDROID_MANIFEST_XML_SUFFIX;
  public static final String RESOURCES_PB_EXPRESSION =
      RESOURCES_PB + ',' + AAB_RESOURCES_PB_EXPRESSION;
  public static final String RESOURCES_EXPRESSION = ARSC_EXPRESSION + ',' + RESOURCES_PB_EXPRESSION;
  public static final String ROOT_RESOURCES_EXPRESSION = RESOURCES_ARSC + ',' + RESOURCES_PB;
  public static final String BASE_RESOURCES_EXPRESSION =
      RESOURCES_ARSC
          + ','
          + AAB_BASE_PREFIX
          + RESOURCES_ARSC
          ...
          + AAB_BASE_PREFIX
          + RESOURCES_PB;
  public static final String CLASSES_DEX_EXPRESSION =
  ...
  public static final String RES_XML_FILE_EXPRESSION =
      APK_RES_XML_FILE_EXPRESSION + ',' + AAB_RES_XML_FILE_EXPRESSION;
  public static final String LIB_FILE_EXPRESSION =
      APK_LIB_FILE_EXPRESSION + ',' + AAB_LIB_FILE_EXPRESSION + ',' + AAR_JNI_FILE_EXPRESSION;
  public static final String APK_AAR_LIB_FILE_EXPRESSION =
      APK_LIB_FILE_EXPRESSION + ',' + AAR_JNI_FILE_EXPRESSION;
  public static final String LIB_DYFILE_EXPRESSION =
      APK_DYLIB_FILE_EXPRESSION + ',' + AAB_DYLIB_FILE_EXPRESSION + ',' + AAR_JNI_DYFILE_EXPRESSION;
  public static final String XML_FILE_EXPRESSION =
      ANDROID_MANIFEST_XML_EXPRESSION + ',' + RES_XML_FILE_EXPRESSION;
  public static final String META_INF_SIGNING_INFO = "META-INF/*.MF,META-INF/*.SF,META-INF/*.RSA";

  public static final String BUNDLE_METADATA_EXPRESSION =
      ZIP_META_INF_EXPRESSION + ',' + AAB_BUNDLE_METADATA_EXPRESSION;
  // Resource paths.
