...
public class DexCodeNode extends DexCodeVisitor {
  ...
  @Override
  public void visitPackedSwitchStmt(
      final Op op, final int aA, final int first_case, final DexLabel[] labels) {
  ...
  @Override
  public void visitSparseSwitchStmt(
      final Op op, final int ra, final int[] cases, final DexLabel[] labels) {
  ...
  public void visitTryCatch(
      final DexLabel start, final DexLabel end, final DexLabel[] handler, final String[] type) {
    if (tryStmts == null) {
