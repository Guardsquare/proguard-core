...
import static proguard.classfile.util.ClassUtil.internalNumericClassNameFromPrimitiveType;
        ...
        case E0:
            ...
            case CONSTANT:
                ...
                if (cst.value.equals(Constant.Null)) {
                    ...
                    if (isInternalPrimitiveType(descriptor))
                    {
                        return code.getstatic(
                            internalNumericClassNameFromPrimitiveType(descriptor.charAt(0)),
                            FIELD_NAME_TYPE,
                            FIELD_TYPE_TYPE
                        );
                    }
