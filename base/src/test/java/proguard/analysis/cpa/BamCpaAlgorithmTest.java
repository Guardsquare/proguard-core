...
public class BamCpaAlgorithmTest {
  ...
  public void interproceduralResultsTest() {
    ClassPool programClassPool =
        ClassPoolBuilder.Companion.fromSource(
                new TestSource[] {
                  new FileSource(
                      new File("src/test/resources/BamCpaAlgorithmTest/interprocedural.java"))
                },
    ...
    Method mainMethod =
        Arrays.stream(clazzA.methods)
            .filter(m -> m.getName(clazzA).equals("main"))
            .findFirst()
            .get();
    ...
    staticFields.put(
        "A.a:I",
        new ExpressionAbstractState(
            Collections.singleton(new ValueExpression(new ParticularIntegerValue(4)))));

    JvmAbstractState<ExpressionAbstractState> expected8 =
        new JvmAbstractState<>(
    ...
    ExpressionAbstractState addResult8 =
        new ExpressionAbstractState(
            Collections.singleton(
                new InstructionExpression(
                    ...
                    Arrays.asList(
                        new ExpressionAbstractState(
                            Collections.singleton(
                                new ValueExpression(new ParticularIntegerValue(4)))),
                        new ExpressionAbstractState(
                            Collections.singleton(
                                new ValueExpression(new ParticularIntegerValue(2))))))));

    ExpressionAbstractState mulResult8 =
        new ExpressionAbstractState(
            Collections.singleton(
                new InstructionExpression(
                    ...
                    Arrays.asList(
                        ...
                        new ExpressionAbstractState(
                            Collections.singleton(
                                new ValueExpression(new ParticularIntegerValue(42))))))));
    ...
    ExpressionAbstractState i2dResult26 =
        new ExpressionAbstractState(
            Collections.singleton(
                new InstructionExpression(
                    new SimpleInstruction(Instruction.OP_I2D),
                    Collections.singletonList(mulResult8))));

    ExpressionAbstractState addResult26 =
        new ExpressionAbstractState(
            Collections.singleton(
                new InstructionExpression(
                    ...
                    Arrays.asList(
                        ...
                        new ExpressionAbstractState(
                            Collections.singleton(
                                new ValueExpression(new ParticularDoubleValue(2.0)))),
                        new ExpressionAbstractState(
                            Collections.singleton(new ValueExpression(UNKNOWN_VALUE)))))));
    ...
    expected26.push(
        new ExpressionAbstractState(
            Collections.singleton(new ValueExpression(new ParticularDoubleValue(42.0)))));
    expected26.push(
        new ExpressionAbstractState(Collections.singleton(new ValueExpression(UNKNOWN_VALUE))));
  ...
  public void limitedRecursionTest() {
    ClassPool programClassPool =
        ClassPoolBuilder.Companion.fromSource(
                new TestSource[] {
                  new FileSource(new File("src/test/resources/BamCpaAlgorithmTest/recursive.java"))
                },
                Arrays.asList("-source", "1.8", "-target", "1.8"),
                Collections.emptyList(),
                getCurrentJavaHome(),
    ...
    JvmAbstractState<ExpressionAbstractState> expected =
        new JvmAbstractState<>(
    ...
    InstructionExpression baseCase1 =
        new InstructionExpression(
            new SimpleInstruction(Instruction.OP_IADD),
            Arrays.asList(
                new ExpressionAbstractState(
                    Collections.singleton(new ValueExpression(new ParticularIntegerValue(2)))),
                new ExpressionAbstractState(
                    Collections.singleton(new ValueExpression(new ParticularIntegerValue(1))))));

    InstructionExpression a1 =
        new InstructionExpression(
    ...
    MethodExpression call1 =
        new MethodExpression(
            MethodSignature.computeIfAbsent(
                    clazzA,
                    Arrays.stream(clazzA.methods)
                        .filter(m -> m.getName(clazzA).equals("sum"))
                        .findFirst()
                        .get())
                .getFqn(),
            Arrays.asList(
    ...
    // the merge join operator for ExpressionAbstractState adds the three possible results of the
    // function call to the set
    ExpressionAbstractState expectedCallResult =
        new ExpressionAbstractState(
            Stream.of(baseCase0, baseCase1, call1).collect(Collectors.toSet()));
  ...
  public void uncaughtExceptionTest() {
    ClassPool programClassPool =
        ClassPoolBuilder.Companion.fromSource(
                new TestSource[] {
                  new FileSource(
                      new File("src/test/resources/BamCpaAlgorithmTest/uncaughtException.java"))
                },
                Arrays.asList("-source", "1.8", "-target", "1.8"),
                Collections.emptyList(),
                getCurrentJavaHome(),
    ...
    assertEquals(
        ...
        reached.asCollection().stream()
            .map(
                r ->
                    ((JvmAbstractState<ExpressionAbstractState>) r)
                        .getProgramLocation()
                        .getOffset())
  ...
  public void caughtExceptionTest() {
    ClassPool programClassPool =
        ClassPoolBuilder.Companion.fromSource(
                new TestSource[] {
                  new FileSource(
                      new File("src/test/resources/BamCpaAlgorithmTest/caughtException.java"))
                },
                Arrays.asList("-source", "1.8", "-target", "1.8"),
                Collections.emptyList(),
                getCurrentJavaHome(),
    ...
    assertEquals(
        cfa.getFunctionNodes(mainSignature).size()
            + cfa.getFunctionCatchNodes(mainSignature).size(),
  ...
  public void successorNoCallEdge() {
    // Regression test: tests that a successor state is produced if the inter-procedural call edge
    // is missing from the CFA
