...
class DifferentialMapAbstractStateTest : FreeSpec({

    val stateEmpty = DifferentialMapAbstractState<Int, IntegerAbstractState>()
    val state1 = DifferentialMapAbstractState<Int, IntegerAbstractState>()
    val state2 = DifferentialMapAbstractState<Int, IntegerAbstractState>()
    val state3 = DifferentialMapAbstractState<Int, IntegerAbstractState>()
    val stateLarge = DifferentialMapAbstractState<Int, IntegerAbstractState>()
