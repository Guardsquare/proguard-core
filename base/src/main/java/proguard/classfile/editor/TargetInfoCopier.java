...
/**
 * This {@link TargetInfoVisitor} copies the target info instances that it visits to the given type
 * annotation (each time overwriting any previous target info).
 *
 * @author Eric Lafortune
 */
public class TargetInfoCopier implements TargetInfoVisitor {
  ...
  public void visitTypeParameterTargetInfo(
    ...
    targetTypeAnnotation.targetInfo =
        new TypeParameterTargetInfo(
            typeParameterTargetInfo.u1targetType, typeParameterTargetInfo.u1typeParameterIndex);
  }
  ...
  public void visitSuperTypeTargetInfo(
    ...
    targetTypeAnnotation.targetInfo =
        new SuperTypeTargetInfo(
            superTypeTargetInfo.u1targetType, superTypeTargetInfo.u2superTypeIndex);
  }
  ...
  public void visitTypeParameterBoundTargetInfo(
    ...
    targetTypeAnnotation.targetInfo =
        new TypeParameterBoundTargetInfo(
            typeParameterBoundTargetInfo.u1targetType,
  ...
  public void visitEmptyTargetInfo(
    ...
    targetTypeAnnotation.targetInfo = new EmptyTargetInfo(emptyTargetInfo.u1targetType);
  }
  ...
  public void visitFormalParameterTargetInfo(
    ...
    targetTypeAnnotation.targetInfo =
        new FormalParameterTargetInfo(
            formalParameterTargetInfo.u1targetType,
  ...
  public void visitThrowsTargetInfo(
    ...
    targetTypeAnnotation.targetInfo =
        new ThrowsTargetInfo(throwsTargetInfo.u1targetType, throwsTargetInfo.u2throwsTypeIndex);
  }
  ...
  public void visitLocalVariableTargetInfo(
    ...
    LocalVariableTargetElement[] table = localVariableTargetInfo.table;
    ...
    LocalVariableTargetInfo newLocalVariableTargetInfo =
        new LocalVariableTargetInfo(
            localVariableTargetInfo.u1targetType, localVariableTargetInfo.u2tableLength, newTable);

    for (int index = 0; index < localVariableTargetInfo.u2tableLength; index++) {
      LocalVariableTargetElement element = localVariableTargetInfo.table[index];

      LocalVariableTargetElement newElement =
          new LocalVariableTargetElement(element.u2startPC, element.u2length, element.u2index);
  ...
  public void visitCatchTargetInfo(
    ...
    targetTypeAnnotation.targetInfo =
        new CatchTargetInfo(catchTargetInfo.u1targetType, catchTargetInfo.u2exceptionTableIndex);
  }
  ...
  public void visitOffsetTargetInfo(
    ...
    targetTypeAnnotation.targetInfo =
        new OffsetTargetInfo(offsetTargetInfo.u1targetType, offsetTargetInfo.u2offset);
  }
  ...
  public void visitTypeArgumentTargetInfo(
    ...
    targetTypeAnnotation.targetInfo =
        new TypeArgumentTargetInfo(
            typeArgumentTargetInfo.u1targetType,
