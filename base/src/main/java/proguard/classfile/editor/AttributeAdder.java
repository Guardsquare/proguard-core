...
/**
 * This {@link AttributeVisitor} adds all attributes that it visits to the given target class, class
 * member, or attribute.
 *
 * @author Eric Lafortune
 */
public class AttributeAdder implements AttributeVisitor {
  ...
  public AttributeAdder(
    ...
    attributesEditor =
        new AttributesEditor(targetClass, targetMember, targetCodeAttribute, replaceAttributes);
  }
  ...
  public void visitUnknownAttribute(Clazz clazz, UnknownAttribute unknownAttribute) {
    ...
    UnknownAttribute newUnknownAttribute =
        new UnknownAttribute(
            constantAdder.addConstant(clazz, unknownAttribute.u2attributeNameIndex),
  ...
  public void visitSourceFileAttribute(Clazz clazz, SourceFileAttribute sourceFileAttribute) {
    ...
    SourceFileAttribute newSourceFileAttribute =
        new SourceFileAttribute(
            constantAdder.addConstant(clazz, sourceFileAttribute.u2attributeNameIndex),
  ...
  public void visitSourceDirAttribute(Clazz clazz, SourceDirAttribute sourceDirAttribute) {
    ...
    SourceDirAttribute newSourceDirAttribute =
        new SourceDirAttribute(
            constantAdder.addConstant(clazz, sourceDirAttribute.u2attributeNameIndex),
  ...
  public void visitSourceDebugExtensionAttribute(
    ...
    SourceDebugExtensionAttribute newSourceDebugExtensionAttribute =
        new SourceDebugExtensionAttribute(
            constantAdder.addConstant(clazz, sourceDebugExtensionAttribute.u2attributeNameIndex),
            sourceDebugExtensionAttribute.u4attributeLength,
            sourceDebugExtensionAttribute.info);

    newSourceDebugExtensionAttribute.setProcessingFlags(
        sourceDebugExtensionAttribute.getProcessingFlags());
  ...
  public void visitInnerClassesAttribute(Clazz clazz, InnerClassesAttribute innerClassesAttribute) {
    ...
    InnerClassesAttribute newInnerClassesAttribute =
        new InnerClassesAttribute(
            constantAdder.addConstant(clazz, innerClassesAttribute.u2attributeNameIndex), 0, null);
  ...
  public void visitEnclosingMethodAttribute(
    ...
    EnclosingMethodAttribute newEnclosingMethodAttribute =
        new EnclosingMethodAttribute(
            constantAdder.addConstant(clazz, enclosingMethodAttribute.u2attributeNameIndex),
  ...
  public void visitNestHostAttribute(Clazz clazz, NestHostAttribute nestHostAttribute) {
    ...
    NestHostAttribute newNestHostAttribute =
        new NestHostAttribute(
            constantAdder.addConstant(clazz, nestHostAttribute.u2attributeNameIndex),
  ...
  public void visitNestMembersAttribute(Clazz clazz, NestMembersAttribute nestMembersAttribute) {
    ...
    NestMembersAttribute newNestMembersAttribute =
        new NestMembersAttribute(
            constantAdder.addConstant(clazz, nestMembersAttribute.u2attributeNameIndex),
            0,
    ...
    nestMembersAttribute.memberClassConstantsAccept(
        targetClass, new NestMemberAdder(targetClass, newNestMembersAttribute));
  ...
  public void visitPermittedSubclassesAttribute(
    ...
    PermittedSubclassesAttribute newPermittedSubclassesAttribute =
        new PermittedSubclassesAttribute(
            constantAdder.addConstant(clazz, permittedSubclassesAttribute.u2attributeNameIndex),
            0,
    ...
    permittedSubclassesAttribute.permittedSubclassConstantsAccept(
        targetClass, new PermittedSubclassAdder(targetClass, newPermittedSubclassesAttribute));
  ...
  public void visitDeprecatedAttribute(Clazz clazz, DeprecatedAttribute deprecatedAttribute) {
    ...
    DeprecatedAttribute newDeprecatedAttribute =
        new DeprecatedAttribute(
            constantAdder.addConstant(clazz, deprecatedAttribute.u2attributeNameIndex));
  ...
  public void visitSyntheticAttribute(Clazz clazz, SyntheticAttribute syntheticAttribute) {
    ...
    SyntheticAttribute newSyntheticAttribute =
        new SyntheticAttribute(
            constantAdder.addConstant(clazz, syntheticAttribute.u2attributeNameIndex));
  ...
  public void visitSignatureAttribute(Clazz clazz, SignatureAttribute signatureAttribute) {
    ...
    SignatureAttribute newSignatureAttribute =
        new SignatureAttribute(
            constantAdder.addConstant(clazz, signatureAttribute.u2attributeNameIndex),
  ...
  public void visitConstantValueAttribute(
    ...
    ConstantValueAttribute newConstantValueAttribute =
        new ConstantValueAttribute(
            constantAdder.addConstant(clazz, constantValueAttribute.u2attributeNameIndex),
  ...
  public void visitMethodParametersAttribute(
    ...
    MethodParametersAttribute newMethodParametersAttribute =
        new MethodParametersAttribute(
            constantAdder.addConstant(clazz, methodParametersAttribute.u2attributeNameIndex),
            methodParametersAttribute.u1parametersCount,
            new ParameterInfo[methodParametersAttribute.u1parametersCount]);

    // Add the local variables.
    methodParametersAttribute.parametersAccept(
        clazz, method, new ParameterInfoAdder(targetClass, newMethodParametersAttribute));
  ...
  public void visitExceptionsAttribute(
    ...
    ExceptionsAttribute newExceptionsAttribute =
        new ExceptionsAttribute(
            constantAdder.addConstant(clazz, exceptionsAttribute.u2attributeNameIndex),
            0,
    ...
    // Add the exceptions.
    exceptionsAttribute.exceptionEntriesAccept(
        clazz, new ExceptionAdder(targetClass, newExceptionsAttribute));
  ...
  public void visitCodeAttribute(Clazz clazz, Method method, CodeAttribute codeAttribute) {
    ...
    CodeAttribute newCodeAttribute =
        new CodeAttribute(
            constantAdder.addConstant(clazz, codeAttribute.u2attributeNameIndex),
    ...
    codeAttribute.instructionsAccept(
        clazz, method, new InstructionAdder(targetClass, codeAttributeComposer));
    ...
    codeAttribute.exceptionsAccept(
        clazz, method, new ExceptionInfoAdder(targetClass, codeAttributeComposer));
    ...
    if (codeAttribute.getAttribute(clazz, Attribute.LINE_NUMBER_TABLE) == null) {
      ...
      codeAttributeComposer.insertLineNumber(block.line(0, 0));
    }
    ...
    codeAttribute.attributesAccept(
        clazz,
        method,
        new AttributeAdder(targetClass, targetMember, newCodeAttribute, replaceAttributes));
  ...
  public void visitLineNumberTableAttribute(
    ...
    LineNumberTableAttribute newLineNumberTableAttribute =
        new LineNumberTableAttribute(
            constantAdder.addConstant(clazz, lineNumberTableAttribute.u2attributeNameIndex),
            0,
            new LineNumberInfo[lineNumberTableAttribute.u2lineNumberTableLength]);

    // Add the line numbers.
    lineNumberTableAttribute.accept(
        clazz, method, codeAttribute, new LineNumberInfoAdder(newLineNumberTableAttribute));
  ...
  public void visitLocalVariableTableAttribute(
    ...
    LocalVariableTableAttribute newLocalVariableTableAttribute =
        new LocalVariableTableAttribute(
            constantAdder.addConstant(clazz, localVariableTableAttribute.u2attributeNameIndex),
            0,
    ...
    newLocalVariableTableAttribute.setProcessingFlags(
        localVariableTableAttribute.getProcessingFlags());
  ...
  public void visitLocalVariableTypeTableAttribute(
    ...
    LocalVariableTypeTableAttribute newLocalVariableTypeTableAttribute =
        new LocalVariableTypeTableAttribute(
            constantAdder.addConstant(clazz, localVariableTypeTableAttribute.u2attributeNameIndex),
            0,
    ...
    newLocalVariableTypeTableAttribute.setProcessingFlags(
        localVariableTypeTableAttribute.getProcessingFlags());
    ...
    RuntimeVisibleAnnotationsAttribute newAnnotationsAttribute =
        new RuntimeVisibleAnnotationsAttribute(
            constantAdder.addConstant(
                clazz, runtimeVisibleAnnotationsAttribute.u2attributeNameIndex),
            0,
            new Annotation[runtimeVisibleAnnotationsAttribute.u2annotationsCount]);

    // Add the annotations.
    runtimeVisibleAnnotationsAttribute.annotationsAccept(
        clazz, new AnnotationAdder(targetClass, newAnnotationsAttribute));

    newAnnotationsAttribute.setProcessingFlags(
        runtimeVisibleAnnotationsAttribute.getProcessingFlags());
  ...
  public void visitRuntimeInvisibleAnnotationsAttribute(
    ...
    RuntimeInvisibleAnnotationsAttribute newAnnotationsAttribute =
        new RuntimeInvisibleAnnotationsAttribute(
            constantAdder.addConstant(
                clazz, runtimeInvisibleAnnotationsAttribute.u2attributeNameIndex),
            0,
            new Annotation[runtimeInvisibleAnnotationsAttribute.u2annotationsCount]);

    // Add the annotations.
    runtimeInvisibleAnnotationsAttribute.annotationsAccept(
        clazz, new AnnotationAdder(targetClass, newAnnotationsAttribute));

    newAnnotationsAttribute.setProcessingFlags(
        runtimeInvisibleAnnotationsAttribute.getProcessingFlags());
  ...
  public void visitRuntimeVisibleParameterAnnotationsAttribute(
    ...
    // Add the annotations.
    runtimeVisibleParameterAnnotationsAttribute.annotationsAccept(
        clazz, method, new AnnotationAdder(targetClass, newParameterAnnotationsAttribute));

    newParameterAnnotationsAttribute.setProcessingFlags(
        runtimeVisibleParameterAnnotationsAttribute.getProcessingFlags());
  ...
  public void visitRuntimeInvisibleParameterAnnotationsAttribute(
    ...
    // Add the annotations.
    runtimeInvisibleParameterAnnotationsAttribute.annotationsAccept(
        clazz, method, new AnnotationAdder(targetClass, newParameterAnnotationsAttribute));

    newParameterAnnotationsAttribute.setProcessingFlags(
        runtimeInvisibleParameterAnnotationsAttribute.getProcessingFlags());
  ...
  public void visitRuntimeVisibleTypeAnnotationsAttribute(
    ...
    RuntimeVisibleTypeAnnotationsAttribute newTypeAnnotationsAttribute =
        new RuntimeVisibleTypeAnnotationsAttribute(
            constantAdder.addConstant(
                clazz, runtimeVisibleTypeAnnotationsAttribute.u2attributeNameIndex),
            0,
    ...
    newTypeAnnotationsAttribute.setProcessingFlags(
        runtimeVisibleTypeAnnotationsAttribute.getProcessingFlags());
  ...
  public void visitRuntimeInvisibleTypeAnnotationsAttribute(
    ...
    RuntimeInvisibleTypeAnnotationsAttribute newTypeAnnotationsAttribute =
        new RuntimeInvisibleTypeAnnotationsAttribute(
            constantAdder.addConstant(
                clazz, runtimeInvisibleTypeAnnotationsAttribute.u2attributeNameIndex),
            0,
    ...
    newTypeAnnotationsAttribute.setProcessingFlags(
        runtimeInvisibleTypeAnnotationsAttribute.getProcessingFlags());
  ...
  public void visitAnnotationDefaultAttribute(
    ...
    AnnotationDefaultAttribute newAnnotationDefaultAttribute =
        new AnnotationDefaultAttribute(
            constantAdder.addConstant(clazz, annotationDefaultAttribute.u2attributeNameIndex),
            null);

    // Add the annotations.
    annotationDefaultAttribute.defaultValueAccept(
        clazz, new ElementValueAdder(targetClass, newAnnotationDefaultAttribute, false));

    newAnnotationDefaultAttribute.setProcessingFlags(
        annotationDefaultAttribute.getProcessingFlags());
