...
/**
 * This editor allows to build or extend classes ({@link LibraryClass} instances). It provides
...
public class LibraryClassBuilder {
   ...
   * @param interfaceClasses references to the interface classes of the interfaces that are
  ...
  /**
   * Returns the created or edited LibraryClass instance. This is a live instance; any later calls
  ...
  public ConstantPoolEditor getConstantPoolEditor() {
    throw new UnsupportedOperationException(
        "Library class [" + libraryClass.thisClassName + "] doesn't store constant pool");
  }
   ...
   * @return this instance of ClassBuilder.
   */
  public LibraryClassBuilder addField(
      int u2accessFlags,
      String fieldName,
      String fieldDescriptor,
      MemberVisitor extraMemberVisitor) {
    // Create the field.
    LibraryField libraryField = addAndReturnField(u2accessFlags, fieldName, fieldDescriptor);
   ...
   */
  public LibraryField addAndReturnField(
   ...
   * @return this instance of ClassBuilder.
   */
  public LibraryClassBuilder addMethod(
  ...
  public LibraryClassBuilder addMethod(
      ...
      MemberVisitor extraMemberVisitor) {
    // Create the method.
    LibraryMethod libraryMethod = addAndReturnMethod(u2accessFlags, methodName, methodDescriptor);
   ...
   */
  public LibraryMethod addAndReturnMethod(
      int u2accessFlags, String methodName, String methodDescriptor) {
