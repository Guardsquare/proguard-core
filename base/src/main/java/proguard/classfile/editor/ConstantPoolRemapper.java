...
/**
 * This {@link ClassVisitor} remaps all possible references to constant pool entries of the classes
 * that it visits, based on a given index map. It is assumed that the constant pool entries
 * themselves have already been remapped.
 *
...
public class ConstantPoolRemapper
  ...
  public void visitProgramClass(ProgramClass programClass) {
    ...
    remapConstantIndexArray(programClass.u2interfaces, programClass.u2interfacesCount);
  ...
  public void visitStringConstant(Clazz clazz, StringConstant stringConstant) {
    stringConstant.u2stringIndex = remapConstantIndex(stringConstant.u2stringIndex);
  }
  ...
  public void visitDynamicConstant(Clazz clazz, DynamicConstant dynamicConstant) {
    dynamicConstant.u2nameAndTypeIndex = remapConstantIndex(dynamicConstant.u2nameAndTypeIndex);
  }
  ...
  public void visitModuleConstant(Clazz clazz, ModuleConstant moduleConstant) {
    moduleConstant.u2nameIndex = remapConstantIndex(moduleConstant.u2nameIndex);
  }

  public void visitPackageConstant(Clazz clazz, PackageConstant packageConstant) {
    packageConstant.u2nameIndex = remapConstantIndex(packageConstant.u2nameIndex);
  }

  public void visitFieldrefConstant(Clazz clazz, FieldrefConstant fieldrefConstant) {
    fieldrefConstant.u2classIndex = remapConstantIndex(fieldrefConstant.u2classIndex);
    fieldrefConstant.u2nameAndTypeIndex = remapConstantIndex(fieldrefConstant.u2nameAndTypeIndex);
  }
