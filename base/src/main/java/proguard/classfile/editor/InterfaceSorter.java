 ...
 */
public class InterfaceSorter implements ClassVisitor, AttributeVisitor {
  ...
  public void visitSignatureAttribute(Clazz clazz, SignatureAttribute signatureAttribute) {
    ...
    for (int interfaceIndex = 0; interfaceIndex < clazz.getInterfaceCount(); interfaceIndex++) {
      ...
      while (internalInterfaceTypeEnumeration.hasMoreTypes()) {
        ...
        DescriptorClassEnumeration classEnumeration = new DescriptorClassEnumeration(type);

        int classCount = classEnumeration.classCount();
