 ...
 *
 * <p>If you're building a class from scratch, it is more efficient to reuse a single instance of
 * this editor for all constants that you add.
 *
...
public class ConstantPoolEditor {
   ...
   * @param programClassPool the program class pool from which new constants can be initialized.
   * @param libraryClassPool the library class pool from which new constants can be initialized.
   * @param cacheIndices specifies whether indices of constants should be cached.
   */
  ConstantPoolEditor(
    ...
    constantReferenceInitializer =
        programClassPool == null
            ? null
  ...
  public int addStringConstant(
    ...
    return addStringConstant(
        addUtf8Constant(string), referencedClass, referencedMember, resourceFileId, resourceFile);
  }
  ...
  public int addStringConstant(
      ...
      int resourceFileId,
      ResourceFile resourceFile) {
    return findOrAddConstant(
        new StringConstant(
            utf8index, referencedClass, referencedMember, resourceFileId, resourceFile));
  }
   ...
   */
  public int addInvokeDynamicConstant(
      int bootstrapMethodIndex, String name, String descriptor, Clazz[] referencedClasses) {
    return addInvokeDynamicConstant(
        bootstrapMethodIndex, addNameAndTypeConstant(name, descriptor), referencedClasses);
  }
   ...
   */
  public int addDynamicConstant(
      int bootstrapMethodIndex, int nameAndTypeIndex, Clazz[] referencedClasses) {
    return findOrAddConstant(
        new DynamicConstant(bootstrapMethodIndex, nameAndTypeIndex, referencedClasses));
  }
  ...
  public int addInvokeDynamicConstant(
      int bootstrapMethodIndex, int nameAndTypeIndex, Clazz[] referencedClasses) {
    return findOrAddConstant(
        new InvokeDynamicConstant(bootstrapMethodIndex, nameAndTypeIndex, referencedClasses));
  }
  ...
  public int addMethodHandleConstant(int referenceKind, int referenceIndex) {
    return findOrAddConstant(new MethodHandleConstant(referenceKind, referenceIndex));
  }
   ...
   * @return the constant pool index of the FieldrefConstant.
   */
  public int addFieldrefConstant(
      String className,
      String name,
      String descriptor,
      Clazz referencedClass,
    ...
    return addFieldrefConstant(
        className, addNameAndTypeConstant(name, descriptor), referencedClass, referencedField);
  }
   ...
   */
  public int addFieldrefConstant(
      String className, int nameAndTypeIndex, Clazz referencedClass, Field referencedField) {
    return addFieldrefConstant(
  ...
  public int addFieldrefConstant(
      ...
      Field referencedField) {
    return addFieldrefConstant(
        classIndex, addNameAndTypeConstant(name, descriptor), referencedClass, referencedField);
  }
   ...
   */
  public int addFieldrefConstant(
      int classIndex, int nameAndTypeIndex, Clazz referencedClass, Field referencedField) {
    return findOrAddConstant(
        new FieldrefConstant(classIndex, nameAndTypeIndex, referencedClass, referencedField));
  }
   ...
   */
  public int addInterfaceMethodrefConstant(
      String className,
      String name,
      String descriptor,
      Clazz referencedClass,
      Method referencedMethod) {
    return addInterfaceMethodrefConstant(
        className, addNameAndTypeConstant(name, descriptor), referencedClass, referencedMethod);
  }
   ...
   */
  public int addInterfaceMethodrefConstant(
      String className, int nameAndTypeIndex, Clazz referencedClass, Method referencedMethod) {
    return addInterfaceMethodrefConstant(
        addClassConstant(className, referencedClass),
        nameAndTypeIndex,
        referencedClass,
  ...
  public int addInterfaceMethodrefConstant(
      ...
      Method referencedMethod) {
    return addInterfaceMethodrefConstant(
        classIndex, addNameAndTypeConstant(name, descriptor), referencedClass, referencedMethod);
  }
   ...
   */
  public int addInterfaceMethodrefConstant(
      int classIndex, int nameAndTypeIndex, Clazz referencedClass, Method referencedMethod) {
    return findOrAddConstant(
        new InterfaceMethodrefConstant(
            classIndex, nameAndTypeIndex, referencedClass, referencedMethod));
  }
   ...
   * @return the constant pool index of the MethodrefConstant.
   */
  public int addMethodrefConstant(
      String className,
      String name,
      String descriptor,
      Clazz referencedClass,
  ...
  public int addMethodrefConstant(
      int classIndex, int nameAndTypeIndex, Clazz referencedClass, Method referencedMethod) {
    return findOrAddConstant(
        new MethodrefConstant(classIndex, nameAndTypeIndex, referencedClass, referencedMethod));
  }
  ...
  public int addClassConstant(Clazz referencedClass) {
    return addClassConstant(referencedClass.getName(), referencedClass);
  }
  ...
  public int addClassConstant(String name, Clazz referencedClass) {
    return addClassConstant(addUtf8Constant(name), referencedClass);
  }
  ...
  public int addMethodTypeConstant(String descriptor, Clazz[] referencedClasses) {
    return addMethodTypeConstant(addUtf8Constant(descriptor), referencedClasses);
  }
  ...
  public int addMethodTypeConstant(int descriptorIndex, Clazz[] referencedClasses) {
    return findOrAddConstant(new MethodTypeConstant(descriptorIndex, referencedClasses));
  }
  ...
  public int addNameAndTypeConstant(String name, String descriptor) {
    return addNameAndTypeConstant(addUtf8Constant(name), addUtf8Constant(descriptor));
  }
  ...
  public int addNameAndTypeConstant(int nameIndex, int descriptorIndex) {
    return findOrAddConstant(new NameAndTypeConstant(nameIndex, descriptorIndex));
  }
  ...
  public int findOrAddConstant(Constant constant) {
    ...
    if (DEBUG) {
      System.out.println(
          "ConstantPoolEditor: ["
              + (targetClass.u2thisClass > 0 ? targetClass.getName() : "(dummy)")
              + ", "
              + constantPoolCount
              + " entries] looking for "
              + constant);
    ...
    if (cachedCount > 0 && cachedCount != constantPoolCount) {
      if (DEBUG) {
        System.out.println(
            "ConstantPoolEditor: ["
                + (targetClass.u2thisClass > 0 ? targetClass.getName() : "(dummy)")
  ...
  public int addConstant(Constant constant) {
      ...
      if (DEBUG) {
        System.out.println(
            "ConstantPoolEditor: ["
                ...
                + ", "
                + constantPoolCount
                + " entries] extending to "
                + (constantPoolCount + SIZE_INCREMENT)
                + " entries");
      }

      targetClass.constantPool =
          constantPool = ArrayUtil.extendArray(constantPool, constantPoolCount + SIZE_INCREMENT);
    }
    ...
    // Update the counts.
    targetClass.u2constantPoolCount = cachedCount = constantPoolCount + constantSize;
