...
public class VersionConstants
{
    ...
    public static final int CLASS_VERSION_20  = (CLASS_VERSION_20_MAJOR  << 16) | CLASS_VERSION_20_MINOR;
    public static final int CLASS_VERSION_21  = (CLASS_VERSION_21_MAJOR  << 16) | CLASS_VERSION_21_MINOR;

    public static final int MAX_SUPPORTED_VERSION = (CLASS_VERSION_21_MAJOR << 16) | PREVIEW_VERSION_MINOR;
}
