...
public class AccessConstants {
  ...
  public static final int RENAMED =
      0x00010000; // Marks whether a class or class member has been renamed.
  public static final int REMOVED_METHODS =
      0x00020000; // Marks whether a class has (at least one) methods removed.
  public static final int REMOVED_FIELDS =
      0x00040000; // Marks whether a class has (at least one) fields removed.

  public static final int VALID_FLAGS_CLASS =
      PUBLIC | FINAL | SUPER | INTERFACE | ABSTRACT | SYNTHETIC | ANNOTATION | MODULE | ENUM;
  ...
  public static final int VALID_FLAGS_METHOD =
      PUBLIC
          ...
          | STRICT
          | SYNTHETIC;
  public static final int VALID_FLAGS_PARAMETER = FINAL | SYNTHETIC | MANDATED;
  public static final int VALID_FLAGS_MODULE = OPEN | SYNTHETIC | MANDATED;
  public static final int VALID_FLAGS_REQUIRES = TRANSITIVE | STATIC_PHASE | SYNTHETIC | MANDATED;
  public static final int VALID_FLAGS_EXPORTS = SYNTHETIC | MANDATED;
  public static final int VALID_FLAGS_OPENS = SYNTHETIC | MANDATED;
}
