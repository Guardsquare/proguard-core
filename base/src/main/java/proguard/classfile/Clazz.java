...
import proguard.util.FeatureNamed;
...
public interface Clazz extends FeatureNamed, Processable {
  ...
  String getString(int constantIndex);

  /** Returns the String value of the StringConstant at the specified index. */
  String getStringString(int constantIndex);
  ...
  /**
   * Returns whether this class extends the given class. A class is always considered to extend
   * itself. Interfaces are considered to only extend the root Object class.
   */
  boolean extends_(Clazz clazz);

  /**
   * Returns whether this class extends the specified class. A class is always considered to extend
   * itself. Interfaces are considered to only extend the root Object class.
   */
  boolean extends_(String className);

  /**
   * Returns whether this class implements the given class. A class is always considered to
   * implement itself. Interfaces are considered to implement all their superinterfaces.
   */
  boolean extendsOrImplements(Clazz clazz);

  /**
   * Returns whether this class implements the specified class. A class is always considered to
   * implement itself. Interfaces are considered to implement all their superinterfaces.
   */
  boolean extendsOrImplements(String className);
   ...
   * @param classVisitor the <code>ClassVisitor</code> that will visit the class hierarchy.
   */
  void hierarchyAccept(
   ...
   *
   * @param classVisitor the <code>ClassVisitor</code> that will visit the subclasses.
   */
  ...
  void fieldAccept(String name, String descriptor, MemberVisitor memberVisitor);
  ...
  void methodAccept(String name, String descriptor, MemberVisitor memberVisitor);

  /**
   * Returns whether the given method may possibly have implementing or overriding methods down the
   * class hierarchy. This can only be true if the class is not final, and the method is not
   * private, static, or final, or a constructor.
   *
  ...
  void attributeAccept(String name, AttributeVisitor attributeVisitor);
