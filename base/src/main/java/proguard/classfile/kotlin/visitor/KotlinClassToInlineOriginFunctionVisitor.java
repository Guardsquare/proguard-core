...
/**
 * This {@link KotlinMetadataVisitor} travels to the function of the provided anonymous object
 * origin and delegates to the given {@link KotlinFunctionVisitor}.
 *
 * <p>e.g. kotlin/properties/Delegates$observable$1 -> visits the observable.
 *
...
public class KotlinClassToInlineOriginFunctionVisitor implements KotlinMetadataVisitor {
  ...
  public KotlinClassToInlineOriginFunctionVisitor(
      String anonymousObjectOriginName, KotlinFunctionVisitor kotlinFunctionVisitor) {
  ...
  public void visitKotlinDeclarationContainerMetadata(
    ...
    kotlinDeclarationContainerMetadata.functionsAccept(
        clazz,
        new KotlinFunctionFilter(fun -> fun.name.equals(funName), this.kotlinFunctionVisitor));
  }
}
