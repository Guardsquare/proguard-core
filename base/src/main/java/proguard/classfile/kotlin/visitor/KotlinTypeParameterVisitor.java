...
public interface KotlinTypeParameterVisitor {
  ...
  default void visitClassTypeParameter(
      Clazz clazz,
  ...
  default void visitPropertyTypeParameter(
      Clazz clazz,
  ...
  default void visitFunctionTypeParameter(
      Clazz clazz,
  ...
  default void visitAliasTypeParameter(
      Clazz clazz,
      KotlinDeclarationContainerMetadata kotlinDeclarationContainerMetadata,
