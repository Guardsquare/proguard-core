...
public class KotlinMetadataPrinter
  ...
  public void visitAnyTypeParameter(
    ...
    pw.println(
        typeParameterFlags(kotlinTypeParameterMetadata.flags) + kotlinTypeParameterMetadata.name);
    ...
    if (kotlinPropertyMetadata.syntheticMethodForDelegate != null) {
      String referencedSyntheticMethodClassNamePrefix =
          kotlinPropertyMetadata.referencedSyntheticMethodForDelegateClass != null
              ...
              ? externalClassName(
                      kotlinPropertyMetadata.referencedSyntheticMethodForDelegateClass.getName())
                  + "."
              : "";
  ...
  @Override
  public void visitAnyContextReceiverType(
  ...
  public void visitAnyVersionRequirement(
    ...
    println(
        "[VRSN] "
            ...
            + ", level: "
            + kotlinVersionRequirementMetadata.level.toString()
            + ", kind: "
            + kotlinVersionRequirementMetadata.kind.toString());
  ...
  public void visitAnyFunction(
    ...
    if (kotlinFunctionMetadata.referencedDefaultImplementationMethod != null) {
      pw.print(
          "defaultImpl: ["
              + externalClassName(
                  kotlinFunctionMetadata.referencedDefaultImplementationMethodClass.getName())
              + "."
    ...
    if (kotlinFunctionMetadata.lambdaClassOriginName != null) {
      println(
          hasRefIndicator(kotlinFunctionMetadata.referencedLambdaClassOrigin)
              + "Lambda class original name: "
              + externalClassName(kotlinFunctionMetadata.lambdaClassOriginName));
    }
  ...
  public void visitAnyAnnotation(
    ...
    println("[ANTN] " + hasRefIndicator(annotation.referencedAnnotationClass) + annotation);
  }
  ...
  public void visitAnyEffectExpression(
    ...
    boolean hasRightHandSides =
        !kotlinEffectExpressionMetadata.orRightHandSides.isEmpty()
  ...
  private static String externalFieldDescription(FieldSignature jvmFieldSignature) {
    try {
      ...
      return externalFullFieldDescription(
          0, jvmFieldSignature.memberName, jvmFieldSignature.descriptor);
  ...
  private String visibilityFlags(KotlinVisibilityFlags flags) {
    return (flags.isInternal ? "internal " : "")
  ...
  private String classFlags(KotlinClassFlags flags) {
    return visibilityFlags(flags.visibility)
        ...
        + (flags.isFun ? "fun interface " : (flags.isInterface ? "interface " : ""))
        +
        // JVM specific flags
  ...
  private String effectExpressionFlags(KotlinEffectExpressionFlags flags) {
    return (flags.isNegated ? "negated " : "")
  ...
  private String typeFlags(KotlinTypeFlags flags) {
    return
    /**
     * The following flags are printed after the name in printKotlinTypeMetadata. (flags.isNullable
     * ? "nullable " : "") + // printed as '?' (flags.isDefinitelyNonNull ? "definitely non null " :
     * "") + // printed as '& Any'
     */
    (flags.isSuspend ? "suspend " : "");
  }
