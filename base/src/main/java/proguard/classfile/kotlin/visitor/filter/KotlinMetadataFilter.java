...
/**
 * This {@link KotlinMetadataVisitor} delegates its visits to one of two given visitors, depending
...
public class KotlinMetadataFilter implements KotlinMetadataVisitor {
  ...
  public KotlinMetadataFilter(
      KotlinMetadataVisitor acceptedVisitor, KotlinMetadataVisitor rejectedVisitor) {
    this(__ -> true, acceptedVisitor, rejectedVisitor);
  }

  public KotlinMetadataFilter(
      Predicate<KotlinMetadata> predicate, KotlinMetadataVisitor acceptedVisitor) {
    this(predicate, acceptedVisitor, null);
  }

  public KotlinMetadataFilter(
      Predicate<KotlinMetadata> predicate,
