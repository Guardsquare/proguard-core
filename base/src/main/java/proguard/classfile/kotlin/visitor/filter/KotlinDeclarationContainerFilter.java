...
public class KotlinDeclarationContainerFilter implements KotlinMetadataVisitor {
  ...
  public KotlinDeclarationContainerFilter(
      Predicate<KotlinDeclarationContainerMetadata> predicate,
  ...
  public void visitKotlinDeclarationContainerMetadata(
    ...
    KotlinMetadataVisitor visitor =
        this.predicate.test(kotlinDeclarationContainerMetadata) ? acceptedVisitor : rejectedVisitor;
    if (visitor != null) {
