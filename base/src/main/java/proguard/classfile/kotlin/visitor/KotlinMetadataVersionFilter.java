...
public class KotlinMetadataVersionFilter
    implements ClassVisitor, AnnotationVisitor, ElementValueVisitor {
  ...
  /**
   * Tests a predicate on the classes' KotlinMetadataVersion and delegates to different
   * ClassVisitors based on the result.
   *
   ...
   */
  public KotlinMetadataVersionFilter(
      Predicate<KotlinMetadataVersion> predicate, ClassVisitor accepted, ClassVisitor rejected) {
