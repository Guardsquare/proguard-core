...
/**
 * Delegates to another {@link KotlinTypeAliasVisitor} if the predicate succeeds; otherwise to the
 * rejected visitor.
 *
...
public class KotlinTypeAliasFilter implements KotlinTypeAliasVisitor {
  ...
  public KotlinTypeAliasFilter(
      Predicate<KotlinTypeAliasMetadata> predicate,
  ...
  public KotlinTypeAliasFilter(
      Predicate<KotlinTypeAliasMetadata> predicate, KotlinTypeAliasVisitor acceptedVisitor) {
