...
public class AllTypeVisitor
  ...
  public void visitTypeOfIsExpression(
    ...
    delegate.visitTypeOfIsExpression(clazz, kotlinEffectExprMetadata, typeOfIs);
  ...
  public void visitConstructorValParamType(
      ...
      KotlinValueParameterMetadata kotlinValueParameterMetadata,
      KotlinTypeMetadata kotlinTypeMetadata) {
    delegate.visitConstructorValParamType(
        clazz,
  ...
  public void visitFunctionContextReceiverType(
      ...
      KotlinFunctionMetadata kotlinFunctionMetadata,
      KotlinTypeMetadata kotlinTypeMetadata) {
    delegate.visitFunctionContextReceiverType(
  ...
  public void visitPropertyContextReceiverType(
      ...
      KotlinPropertyMetadata kotlinPropertyMetadata,
      KotlinTypeMetadata kotlinTypeMetadata) {
    delegate.visitPropertyContextReceiverType(
  ...
  public void visitPropertyReceiverType(
      ...
      KotlinPropertyMetadata kotlinPropertyMetadata,
      KotlinTypeMetadata kotlinTypeMetadata) {
    delegate.visitPropertyReceiverType(
        clazz, kotlinDeclarationContainerMetadata, kotlinPropertyMetadata, kotlinTypeMetadata);
  ...
  public void visitPropertyValParamType(
      ...
      KotlinValueParameterMetadata kotlinValueParameterMetadata,
      KotlinTypeMetadata kotlinTypeMetadata) {
    delegate.visitPropertyValParamType(
        clazz,
        kotlinDeclarationContainerMetadata,
  ...
  public void visitFunctionReturnType(
      ...
      KotlinFunctionMetadata kotlinFunctionMetadata,
      KotlinTypeMetadata kotlinTypeMetadata) {
    delegate.visitFunctionReturnType(
        clazz, kotlinMetadata, kotlinFunctionMetadata, kotlinTypeMetadata);
  ...
  public void visitFunctionReceiverType(
      ...
      KotlinFunctionMetadata kotlinFunctionMetadata,
      KotlinTypeMetadata kotlinTypeMetadata) {
    delegate.visitFunctionReceiverType(
        clazz, kotlinMetadata, kotlinFunctionMetadata, kotlinTypeMetadata);
  ...
  public void visitFunctionValParamType(
      ...
      KotlinValueParameterMetadata kotlinValueParameterMetadata,
      KotlinTypeMetadata kotlinTypeMetadata) {
    delegate.visitFunctionValParamType(
        clazz,
        kotlinMetadata,
  ...
  public void visitFunctionValParamVarArgType(
      ...
      KotlinValueParameterMetadata kotlinValueParameterMetadata,
      KotlinTypeMetadata kotlinTypeMetadata) {
    delegate.visitFunctionValParamVarArgType(
        clazz,
        kotlinMetadata,
        kotlinFunctionMetadata,
        kotlinValueParameterMetadata,
  ...
  public void visitAliasUnderlyingType(
      ...
      KotlinTypeAliasMetadata kotlinTypeAliasMetadata,
      KotlinTypeMetadata kotlinTypeMetadata) {
    delegate.visitAliasUnderlyingType(
        clazz, kotlinDeclarationContainerMetadata, kotlinTypeAliasMetadata, kotlinTypeMetadata);
  ...
  public void visitAliasExpandedType(
      ...
      KotlinTypeAliasMetadata kotlinTypeAliasMetadata,
      KotlinTypeMetadata kotlinTypeMetadata) {
    delegate.visitAliasExpandedType(
        clazz, kotlinDeclarationContainerMetadata, kotlinTypeAliasMetadata, kotlinTypeMetadata);
