...
public class KotlinPropertyFilter implements KotlinPropertyVisitor {
  ...
  public KotlinPropertyFilter(
      Predicate<KotlinPropertyMetadata> predicate,
  ...
  public KotlinPropertyFilter(
      Predicate<KotlinPropertyMetadata> predicate, KotlinPropertyVisitor acceptedPropertyVisitor) {
  ...
  public void visitAnyProperty(
    ...
    KotlinPropertyVisitor visitor =
        this.predicate.test(kotlinPropertyMetadata)
            ? acceptedPropertyVisitor
            : rejectedPropertyVisitor;
    if (visitor != null) {
