...
public class KotlinTypeFilter implements KotlinTypeVisitor {
  ...
  public KotlinTypeFilter(
      Predicate<KotlinTypeMetadata> predicate, KotlinTypeVisitor kotlinTypeVisitor) {
  ...
  public void visitConstructorValParamType(
    ...
    if (this.predicate.test(kotlinTypeMetadata)) {
      this.kotlinTypeVisitor.visitConstructorValParamType(
          clazz,
  ...
  public void visitConstructorValParamVarArgType(
      ...
      KotlinTypeMetadata kotlinTypeMetadata) {
    if (this.predicate.test(kotlinTypeMetadata)) {
      this.kotlinTypeVisitor.visitConstructorValParamVarArgType(
          clazz,
          kotlinDeclarationContainerMetadata,
          kotlinConstructorMetadata,
          kotlinValueParameterMetadata,
  ...
  public void visitPropertyType(
      ...
      KotlinTypeMetadata kotlinTypeMetadata) {
    if (this.predicate.test(kotlinTypeMetadata)) {
      this.kotlinTypeVisitor.visitPropertyType(
          clazz, kotlinDeclarationContainerMetadata, kotlinPropertyMetadata, kotlinTypeMetadata);
    }
  }
  ...
  public void visitPropertyReceiverType(
      ...
      KotlinTypeMetadata kotlinTypeMetadata) {
    if (this.predicate.test(kotlinTypeMetadata)) {
      this.kotlinTypeVisitor.visitPropertyReceiverType(
          clazz, kotlinDeclarationContainerMetadata, kotlinPropertyMetadata, kotlinTypeMetadata);
    }
  }
  ...
  public void visitPropertyValParamType(
      ...
      KotlinTypeMetadata kotlinTypeMetadata) {
    if (this.predicate.test(kotlinTypeMetadata)) {
      this.kotlinTypeVisitor.visitPropertyValParamType(
          clazz,
          kotlinDeclarationContainerMetadata,
  ...
  public void visitPropertyValParamVarArgType(
      ...
      KotlinTypeMetadata kotlinTypeMetadata) {
    if (this.predicate.test(kotlinTypeMetadata)) {
      this.kotlinTypeVisitor.visitPropertyValParamVarArgType(
          clazz,
          kotlinDeclarationContainerMetadata,
          kotlinPropertyMetadata,
          kotlinValueParameterMetadata,
  ...
  public void visitFunctionReturnType(
      ...
      KotlinTypeMetadata kotlinTypeMetadata) {
    if (this.predicate.test(kotlinTypeMetadata)) {
      this.kotlinTypeVisitor.visitFunctionReturnType(
  ...
  public void visitFunctionReceiverType(
      ...
      KotlinTypeMetadata kotlinTypeMetadata) {
    if (this.predicate.test(kotlinTypeMetadata)) {
      this.kotlinTypeVisitor.visitFunctionReceiverType(
          clazz, kotlinMetadata, kotlinFunctionMetadata, kotlinTypeMetadata);
    }
  }
  ...
  public void visitFunctionValParamType(
      ...
      KotlinTypeMetadata kotlinTypeMetadata) {
    if (this.predicate.test(kotlinTypeMetadata)) {
      this.kotlinTypeVisitor.visitFunctionValParamType(
          clazz,
          kotlinMetadata,
  ...
  public void visitFunctionValParamVarArgType(
      ...
      KotlinTypeMetadata kotlinTypeMetadata) {
    if (this.predicate.test(kotlinTypeMetadata)) {
      this.kotlinTypeVisitor.visitFunctionValParamVarArgType(
          clazz,
          kotlinMetadata,
          kotlinFunctionMetadata,
          kotlinValueParameterMetadata,
  ...
  public void visitAliasUnderlyingType(
    ...
    if (this.predicate.test(underlyingType)) {
      this.kotlinTypeVisitor.visitAliasUnderlyingType(
          clazz, kotlinDeclarationContainerMetadata, kotlinTypeAliasMetadata, underlyingType);
    }
  }
  ...
  public void visitAliasExpandedType(
    ...
    if (this.predicate.test(expandedType)) {
      this.kotlinTypeVisitor.visitAliasExpandedType(
          clazz, kotlinDeclarationContainerMetadata, kotlinTypeAliasMetadata, expandedType);
    }
  }
}
