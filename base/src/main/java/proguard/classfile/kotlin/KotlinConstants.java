...
public class KotlinConstants {
  ...
  public static final String NAME_KOTLIN_FUNCTION =
      "kotlin/Function"; // kotlin/Function and also kotlin/FunctionN
  ...
  public static final String NAME_KOTLIN_COROUTINES_DEBUG_METADATA =
      "kotlin/coroutines/jvm/internal/DebugMetadata";
  public static final String TYPE_KOTLIN_JVM_JVMNAME = "Lkotlin/jvm/JvmName;";
  public static final String TYPE_KOTLIN_DEFAULT_CONSTRUCTOR_MARKER =
  ...
  public static final class REFLECTION {
    ...
    public static final String CALLABLE_REFERENCE_CLASS_NAME =
        "kotlin/jvm/internal/CallableReference";
    public static final String FUNCTION_REFERENCE_CLASS_NAME =
        "kotlin/jvm/internal/FunctionReference";
    public static final String PROPERTY_REFERENCE_CLASS_NAME =
        "kotlin/jvm/internal/PropertyReference";
    public static final String LOCALVAR_REFERENCE_CLASS_NAME =
    ...
    public static final String GETORCREATEKOTLINCLASS_METHOD_DESC =
    ...
    public static final String GETORCREATEKOTLINPACKAGE_METHOD_DESC =
  ...
  public static final ClassPool dummyClassPool =
      new ClassPool() {
        ...
        public Clazz getClass(String className) {
          ...
          if (clazz == null
              && (className.startsWith("kotlin/Function")
                  || className.startsWith("kotlin/reflect/KFunction"))) {
   ...
   * @return Kotlin type class or the original Java type class if it doesn't have a Kotlin
   *     equivalent
   */
