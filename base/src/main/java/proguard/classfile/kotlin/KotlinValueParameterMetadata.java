...
public class KotlinValueParameterMetadata extends SimpleProcessable
  ...
  public KotlinValueParameterMetadata(
      KotlinValueParameterFlags flags, int index, String parameterName) {
  ...
  public void accept(
    ...
    kotlinValueParameterVisitor.visitConstructorValParameter(
  ...
  public void accept(
      ...
      KotlinValueParameterVisitor kotlinValueParameterVisitor) {
    kotlinValueParameterVisitor.visitFunctionValParameter(
  ...
  public void accept(
      ...
      KotlinValueParameterVisitor kotlinValueParameterVisitor) {
    kotlinValueParameterVisitor.visitPropertyValParameter(
  ...
  public void typeAccept(
    ...
    kotlinTypeVisitor.visitFunctionValParamType(
        clazz, kotlinMetadata, kotlinFunctionMetadata, this, type);

    if (varArgElementType != null) {
      kotlinTypeVisitor.visitFunctionValParamVarArgType(
          clazz, kotlinMetadata, kotlinFunctionMetadata, this, varArgElementType);
    }
  }
  ...
  public void typeAccept(
      ...
      KotlinConstructorMetadata kotlinConstructorMetadata,
      KotlinTypeVisitor kotlinTypeVisitor) {
    kotlinTypeVisitor.visitConstructorValParamType(
        clazz, kotlinClassKindMetadata, kotlinConstructorMetadata, this, type);

    if (varArgElementType != null) {
      kotlinTypeVisitor.visitConstructorValParamVarArgType(
          clazz, kotlinClassKindMetadata, kotlinConstructorMetadata, this, varArgElementType);
    }
  }
  ...
  public void typeAccept(
      ...
      KotlinPropertyMetadata kotlinPropertyMetadata,
      KotlinTypeVisitor kotlinTypeVisitor) {
    kotlinTypeVisitor.visitPropertyValParamType(
        clazz, kotlinDeclarationContainerMetadata, kotlinPropertyMetadata, this, type);

    if (varArgElementType != null) {
      kotlinTypeVisitor.visitPropertyValParamVarArgType(
          clazz,
