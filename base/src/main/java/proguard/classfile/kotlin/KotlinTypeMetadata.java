...
public class KotlinTypeMetadata extends SimpleProcessable
  ...
  public void underlyingPropertyTypeAccept(
      Clazz clazz,
      KotlinClassKindMetadata kotlinClassKindMetadata,
      KotlinTypeVisitor kotlinTypeVisitor) {
  ...
  private void acceptAsUpperBound(
      Clazz clazz, KotlinTypeMetadata boundedType, KotlinTypeVisitor kotlinTypeVisitor) {
  ...
  private void acceptAsAbbreviation(
      Clazz clazz, KotlinTypeMetadata abbreviatedType, KotlinTypeVisitor kotlinTypeVisitor) {
  ...
  public void referencedTypeAliasAccept(
      Clazz clazz, KotlinTypeAliasVisitor kotlinTypeAliasVisitor) {
    if (this.referencedTypeAlias != null
        && this.referencedTypeAlias.referencedDeclarationContainer != null) {
      this.referencedTypeAlias.accept(
          clazz, this.referencedTypeAlias.referencedDeclarationContainer, kotlinTypeAliasVisitor);
    }
  }
  ...
  /**
   * This KotlinTypeMetadata represents a star projection (a generics wildcard). It can be stored in
   * the typeArguments array by calling KotlinTypeMetadata.starProjection().
   */
  private static class KotlinStarProjectionMetadata extends KotlinTypeMetadata {
    KotlinStarProjectionMetadata() {
      super(new KotlinTypeFlags());
    }
