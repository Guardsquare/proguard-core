...
/**
 * Represents an argument of a {@link KotlinAnnotation} e.g. <code>
 * @Annotation(arg1 = "String", arg2 = 1)
 * </code> An argument consists of a name and a value:
 *
 * <p>- The name which references a Java annotation method. - The value is an instance of sub-type
 * of {@link Value}.
 *
...
public class KotlinAnnotationArgument extends SimpleProcessable implements Processable {
  ...
  public static final class ClassValue implements Value {
    ...
    @Override
    public String toString() {
      return String.join("", nCopies(this.arrayDimensionsCount, "["))
          + externalClassName(this.className);
    }
  ...
  public static final class AnnotationValue implements Value {
    ...
    public void annotationAccept(
        Clazz clazz, KotlinAnnotatable annotatable, KotlinAnnotationVisitor visitor) {
  ...
  public static final class ArrayValue implements Value {
    ...
    public void elementsAccept(
      ...
      this.elements.forEach(
          element -> element.accept(clazz, annotatable, kotlinAnnotation, argument, visitor));
    }
  }
}
