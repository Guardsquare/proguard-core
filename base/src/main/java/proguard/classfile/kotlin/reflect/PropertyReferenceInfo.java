...
public class PropertyReferenceInfo implements CallableReferenceInfo {
   ...
   *
   * <p>If the property has no getter in the bytecode (e.g. private property in a class), it's still
   * the signature of the imaginary default getter that would be generated otherwise e.g.
