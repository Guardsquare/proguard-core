...
public class RecordComponentInfo extends SimpleProcessable {
  ...
  /**
   * An extra field optionally pointing to the referenced Field object. This field is typically
  ...
  public RecordComponentInfo(
      int u2nameIndex, int u2descriptorIndex, int u2attributesCount, Attribute[] attributes) {
