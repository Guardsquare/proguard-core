...
/**
 * This interface specifies the methods for a visitor of {@link Annotation} instances. Note that
 * there is only a single implementation of {@link Annotation}, such that this interface is not
...
public interface AnnotationVisitor {
  /**
   * Visits any Annotation instance. The more specific default implementations of this interface
   * delegate to this method.
   */
  default void visitAnnotation(Clazz clazz, Annotation annotation) {
    throw new UnsupportedOperationException(
        this.getClass().getName() + " does not support " + annotation.getClass().getName());
  }
