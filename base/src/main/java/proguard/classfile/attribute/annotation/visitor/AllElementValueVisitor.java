...
/**
 * This {@link AttributeVisitor} and {@link AnnotationVisitor} lets a given {@link
 * ElementValueVisitor} visit all {@link ElementValue} instances of the attributes or annotations
 * that it visits.
 *
...
public class AllElementValueVisitor
   ...
   *
   * @param elementValueVisitor the AllElementValueVisitor to which visits will be delegated.
   */
   ...
   * Creates a new AllElementValueVisitor.
   *
   * @param deep specifies whether the element values further down the hierarchy should be visited
   *     too.
   * @param elementValueVisitor the AllElementValueVisitor to which visits will be delegated.
   */
  public AllElementValueVisitor(boolean deep, ElementValueVisitor elementValueVisitor) {
    this.deep = deep;
