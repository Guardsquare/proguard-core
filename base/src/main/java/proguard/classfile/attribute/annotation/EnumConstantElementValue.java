...
public class EnumConstantElementValue extends ElementValue {
   ...
   * ClassReferenceInitializer}</code>. References to primitive types are ignored.
   */
  public Clazz[] referencedClasses;

  /**
   * An extra field optionally pointing to the referenced enum Field object. This field is typically
  ...
  public EnumConstantElementValue(
      int u2elementNameIndex, int u2typeNameIndex, int u2constantNameIndex) {
  ...
  public void referencedFieldAccept(MemberVisitor memberVisitor) {
    if (referencedField != null) {
      referencedField.accept(referencedClasses[0], memberVisitor);
    }
  }
