...
public class LineNumberTableAttribute extends Attribute {
  ...
  public LineNumberTableAttribute(
      int u2attributeNameIndex, int u2lineNumberTableLength, LineNumberInfo[] lineNumberTable) {
  ...
  public LineNumberInfo getLineNumberInfo(int pc) {
    ...
    return u2lineNumberTableLength > 0 ? lineNumberTable[0] : null;
  }
  ...
  public void lineNumbersAccept(
    ...
    for (int index = 0; index < u2lineNumberTableLength; index++) {
      ...
      lineNumberInfoVisitor.visitLineNumberInfo(
          clazz, method, codeAttribute, lineNumberTable[index]);
    }
  }
}
