...
public class LocalVariableTypeInfo extends SimpleProcessable implements Comparable {
  ...
  /**
   * An extra field pointing to the Clazz objects referenced in the type string. This field is
  ...
  public LocalVariableTypeInfo(
      int u2startPC, int u2length, int u2nameIndex, int u2signatureIndex, int u2index) {
            ...
            : this.u2index < other.u2index
                ...
                : this.u2index > other.u2index
                    ...
                    : this.u2length < other.u2length
                        ...
                        : this.u2length > other.u2length
                            ? 1
                            : this.u2signatureIndex < other.u2signatureIndex
                                ? -1
                                : this.u2signatureIndex > other.u2signatureIndex
                                    ? 1
