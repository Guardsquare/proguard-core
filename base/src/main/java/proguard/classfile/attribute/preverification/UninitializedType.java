...
public class UninitializedType extends VerificationType {
  ...
  public void accept(
    ...
    verificationTypeVisitor.visitUninitializedType(
  ...
  public void stackAccept(
      ...
      int stackIndex,
      VerificationTypeVisitor verificationTypeVisitor) {
    verificationTypeVisitor.visitStackUninitializedType(
  ...
  public void variablesAccept(
      ...
      int variableIndex,
      VerificationTypeVisitor verificationTypeVisitor) {
    verificationTypeVisitor.visitVariablesUninitializedType(
  ...
  public int hashCode() {
    return super.hashCode() ^ u2newInstructionOffset;
  }
