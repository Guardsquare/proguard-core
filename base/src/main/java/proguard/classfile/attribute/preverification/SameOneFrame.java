...
/**
 * This {@link StackMapFrame} represents a "same locals 1 stack item frame" or a "same locals 1
...
public class SameOneFrame extends StackMapFrame {
  ...
  public int getTag() {
    return u2offsetDelta < 64 ? SAME_ONE_FRAME + u2offsetDelta : SAME_ONE_FRAME_EXTENDED;
  }
  ...
  public boolean equals(Object object) {
    ...
    return this.u2offsetDelta == other.u2offsetDelta && this.stackItem.equals(other.stackItem);
  }
