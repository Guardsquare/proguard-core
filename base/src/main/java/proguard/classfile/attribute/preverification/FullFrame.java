...
public class FullFrame extends StackMapFrame {
  ...
  public void variablesAccept(
    ...
    for (int index = 0; index < variablesCount; index++) {
      variables[index].variablesAccept(
          clazz, method, codeAttribute, offset, index, verificationTypeVisitor);
    }
  }
  ...
  public String toString() {
    ...
    for (int index = 0; index < stackCount; index++) {
      buffer = buffer.append('[').append(stack[index].toString()).append(']');
    }
