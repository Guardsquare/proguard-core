...
public class CodeAttribute extends Attribute {
  ...
  public CodeAttribute(
      int u2attributeNameIndex, int u2maxStack, int u2maxLocals, int u4codeLength, byte[] code) {
    this(
  ...
  public void instructionsAccept(
      Clazz clazz, Method method, InstructionVisitor instructionVisitor) {
  ...
  public void instructionAccept(
      Clazz clazz, Method method, int offset, InstructionVisitor instructionVisitor) {
  ...
  public void exceptionsAccept(
      Clazz clazz, Method method, ExceptionInfoVisitor exceptionInfoVisitor) {
   ...
   */
  public void exceptionsAccept(
      Clazz clazz, Method method, int offset, ExceptionInfoVisitor exceptionInfoVisitor) {
    for (int index = 0; index < u2exceptionTableLength; index++) {
