...
/**
 * This {@link AttributeVisitor} delegates its visits to one of two other {@link AttributeVisitor}
 * instances, depending on whether the visited attribute is strictly required or not.
 *
 * <p>Stack map attributes and stack map table attributes are treated as optional.
 *
...
public class RequiredAttributeFilter implements AttributeVisitor {
   ...
   *
   * @param requiredAttributeVisitor the visitor that will visit required attributes.
   */
   ...
   *
   * @param requiredAttributeVisitor the visitor that will visit required attributes.
   * @param optionalAttributeVisitor the visitor that will visit optional attributes.
   */
  public RequiredAttributeFilter(
      AttributeVisitor requiredAttributeVisitor, AttributeVisitor optionalAttributeVisitor) {
  ...
  public void visitSourceDebugExtensionAttribute(
    ...
    if (optionalAttributeVisitor != null) {
      optionalAttributeVisitor.visitSourceDebugExtensionAttribute(
  ...
  public void visitPermittedSubclassesAttribute(
    ...
    if (requiredAttributeVisitor != null) {
      requiredAttributeVisitor.visitPermittedSubclassesAttribute(
          clazz, permittedSubclassesAttribute);
    }
  }
  ...
  public void visitSignatureAttribute(
    ...
    if (optionalAttributeVisitor != null) {
      optionalAttributeVisitor.visitSignatureAttribute(
  ...
  public void visitStackMapAttribute(
    ...
    if (optionalAttributeVisitor != null) {
      optionalAttributeVisitor.visitStackMapAttribute(
  ...
  public void visitStackMapTableAttribute(
    ...
    if (optionalAttributeVisitor != null) {
      optionalAttributeVisitor.visitStackMapTableAttribute(
  ...
  public void visitLineNumberTableAttribute(
    ...
    if (optionalAttributeVisitor != null) {
      optionalAttributeVisitor.visitLineNumberTableAttribute(
  ...
  public void visitLocalVariableTableAttribute(
    ...
    if (optionalAttributeVisitor != null) {
      optionalAttributeVisitor.visitLocalVariableTableAttribute(
  ...
  public void visitLocalVariableTypeTableAttribute(
    ...
    if (optionalAttributeVisitor != null) {
      optionalAttributeVisitor.visitLocalVariableTypeTableAttribute(
  ...
  public void visitRuntimeVisibleAnnotationsAttribute(
    ...
    if (optionalAttributeVisitor != null) {
      optionalAttributeVisitor.visitRuntimeVisibleAnnotationsAttribute(
  ...
  public void visitRuntimeInvisibleAnnotationsAttribute(
    ...
    if (optionalAttributeVisitor != null) {
      optionalAttributeVisitor.visitRuntimeInvisibleAnnotationsAttribute(
  ...
  public void visitRuntimeVisibleParameterAnnotationsAttribute(
    ...
    if (optionalAttributeVisitor != null) {
      optionalAttributeVisitor.visitRuntimeVisibleParameterAnnotationsAttribute(
  ...
  public void visitRuntimeInvisibleParameterAnnotationsAttribute(
    ...
    if (optionalAttributeVisitor != null) {
      optionalAttributeVisitor.visitRuntimeInvisibleParameterAnnotationsAttribute(
  ...
  public void visitRuntimeVisibleTypeAnnotationsAttribute(
    ...
    if (optionalAttributeVisitor != null) {
      optionalAttributeVisitor.visitRuntimeVisibleTypeAnnotationsAttribute(
  ...
  public void visitRuntimeInvisibleTypeAnnotationsAttribute(
    ...
    if (optionalAttributeVisitor != null) {
      optionalAttributeVisitor.visitRuntimeInvisibleTypeAnnotationsAttribute(
  ...
  public void visitAnnotationDefaultAttribute(
    ...
    if (optionalAttributeVisitor != null) {
      optionalAttributeVisitor.visitAnnotationDefaultAttribute(
