...
/**
 * This {@link AttributeVisitor} delegates all visits to each {@link AttributeVisitor} in a given
 * list.
 *
...
public class MultiAttributeVisitor implements AttributeVisitor {
  ...
  public void addAttributeVisitor(AttributeVisitor attributeVisitor) {
    attributeVisitors = ArrayUtil.add(attributeVisitors, attributeVisitorCount++, attributeVisitor);
  }
  ...
  public void visitSourceDebugExtensionAttribute(
    ...
    for (int index = 0; index < attributeVisitorCount; index++) {
      attributeVisitors[index].visitSourceDebugExtensionAttribute(
  ...
  public void visitPermittedSubclassesAttribute(
    ...
    for (int index = 0; index < attributeVisitorCount; index++) {
      attributeVisitors[index].visitPermittedSubclassesAttribute(
  ...
  public void visitSignatureAttribute(
      Clazz clazz, RecordComponentInfo recordComponentInfo, SignatureAttribute syntheticAttribute) {
    for (int index = 0; index < attributeVisitorCount; index++) {
      attributeVisitors[index].visitSignatureAttribute(
          clazz, recordComponentInfo, syntheticAttribute);
    }
  }

  public void visitSignatureAttribute(
      Clazz clazz, Field field, SignatureAttribute syntheticAttribute) {
    for (int index = 0; index < attributeVisitorCount; index++) {
  ...
  public void visitSignatureAttribute(
      Clazz clazz, Method method, SignatureAttribute syntheticAttribute) {
    for (int index = 0; index < attributeVisitorCount; index++) {
  ...
  public void visitStackMapAttribute(
    ...
    for (int index = 0; index < attributeVisitorCount; index++) {
      attributeVisitors[index].visitStackMapAttribute(
  ...
  public void visitStackMapTableAttribute(
    ...
    for (int index = 0; index < attributeVisitorCount; index++) {
      attributeVisitors[index].visitStackMapTableAttribute(
  ...
  public void visitLineNumberTableAttribute(
    ...
    for (int index = 0; index < attributeVisitorCount; index++) {
      attributeVisitors[index].visitLineNumberTableAttribute(
  ...
  public void visitLocalVariableTableAttribute(
    ...
    for (int index = 0; index < attributeVisitorCount; index++) {
      attributeVisitors[index].visitLocalVariableTableAttribute(
  ...
  public void visitLocalVariableTypeTableAttribute(
    ...
    for (int index = 0; index < attributeVisitorCount; index++) {
      attributeVisitors[index].visitLocalVariableTypeTableAttribute(
  ...
  public void visitRuntimeVisibleAnnotationsAttribute(
    ...
    for (int index = 0; index < attributeVisitorCount; index++) {
      attributeVisitors[index].visitRuntimeVisibleAnnotationsAttribute(
  ...
  public void visitRuntimeInvisibleAnnotationsAttribute(
    ...
    for (int index = 0; index < attributeVisitorCount; index++) {
      attributeVisitors[index].visitRuntimeInvisibleAnnotationsAttribute(
  ...
  public void visitRuntimeVisibleParameterAnnotationsAttribute(
    ...
    for (int index = 0; index < attributeVisitorCount; index++) {
      attributeVisitors[index].visitRuntimeVisibleParameterAnnotationsAttribute(
  ...
  public void visitRuntimeInvisibleParameterAnnotationsAttribute(
    ...
    for (int index = 0; index < attributeVisitorCount; index++) {
      attributeVisitors[index].visitRuntimeInvisibleParameterAnnotationsAttribute(
  ...
  public void visitAnnotationDefaultAttribute(
    ...
    for (int index = 0; index < attributeVisitorCount; index++) {
      attributeVisitors[index].visitAnnotationDefaultAttribute(
