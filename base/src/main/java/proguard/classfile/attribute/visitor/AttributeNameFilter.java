...
public class AttributeNameFilter implements AttributeVisitor {
   ...
   *
   * @param regularExpression the regular expression against which attribute names will be matched.
   * @param attributeVisitor the <code>AttributeVisitor</code> to which visits will be delegated.
   */
  public AttributeNameFilter(String regularExpression, AttributeVisitor attributeVisitor) {
    this(new ListParser(new NameParser()).parse(regularExpression), attributeVisitor);
  }
   ...
   * @param attributeVisitor the <code>AttributeVisitor</code> to which visits will be delegated.
   */
  public AttributeNameFilter(List regularExpression, AttributeVisitor attributeVisitor) {
    this(new ListParser(new NameParser()).parse(regularExpression), attributeVisitor);
  }
   ...
   * Creates a new AttributeNameFilter.
   *
   * @param regularExpressionMatcher the string matcher against which attribute names will be
   *     matched.
   * @param attributeVisitor the <code>AttributeVisitor</code> to which visits will be delegated.
   */
  public AttributeNameFilter(
      StringMatcher regularExpressionMatcher, AttributeVisitor attributeVisitor) {
