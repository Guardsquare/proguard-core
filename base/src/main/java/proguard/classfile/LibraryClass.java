...
public class LibraryClass extends SimpleFeatureNamedProcessable implements Clazz {
  ...
  /**
   * An extra field pointing to the superclass of this class. This field is filled out by the {@link
   * ClassSuperHierarchyInitializer}.
   */
  public Clazz superClass;

  /**
   * An extra field pointing to the interfaces of this class. This field is filled out by the {@link
   * ClassSuperHierarchyInitializer}.
   */
  public Clazz[] interfaceClasses = EMPTY_CLASSES;

  /**
   * An extra field pointing to the subclasses of this class. This field is filled out by the {@link
  ...
  public boolean mayHaveImplementations(Method method) {
    return (u2accessFlags & AccessConstants.FINAL) == 0
        && (method == null
