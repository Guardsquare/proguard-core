...
public class ClassProcessingInfoFilter implements ClassVisitor {
   ...
   * @param acceptedClassVisitor the class visitor for classes that have the given visitor info.
   */
   ...
   * @param acceptedClassVisitor the class visitor for classes that have the given visitor info.
   * @param rejectedClassVisitor the class visitor for classes that don't have the given visitor
   *     info.
   */
  public ClassProcessingInfoFilter(
  ...
  private ClassVisitor getDelegate(Processable processable) {
    return this.predicate.test(processable.getProcessingInfo())
        ? this.acceptedClassVisitor
        : this.rejectedClassVisitor;
  }
}
