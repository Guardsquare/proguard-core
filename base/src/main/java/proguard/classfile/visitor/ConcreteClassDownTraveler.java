...
/**
 * This {@link ClassVisitor} lets a given {@link ClassVisitor} travel to the first concrete
...
public class ConcreteClassDownTraveler implements ClassVisitor {
  ...
  public void visitProgramClass(ProgramClass programClass) {
    ...
    if ((programClass.getAccessFlags() & (AccessConstants.INTERFACE | AccessConstants.ABSTRACT))
        != 0) {
  ...
  public void visitLibraryClass(LibraryClass libraryClass) {
    ...
    if ((libraryClass.getAccessFlags() & (AccessConstants.INTERFACE | AccessConstants.ABSTRACT))
        != 0) {
      // Travel down the hierarchy.
