 ...
 * ExceptionInfoVisitor}, but only when the visited exception covers the instruction at the given
 * offset.
 *
...
public class ExceptionOffsetFilter implements ExceptionInfoVisitor {
   ...
   */
  public ExceptionOffsetFilter(int instructionOffset, ExceptionInfoVisitor exceptionInfoVisitor) {
