...
/**
 * This {@link InstructionVisitor} lets a given {@link ClassVisitor} visit all classes involved in
 * any <code>.class</code> constructs that it visits.
 *
 * <p>Note that before JDK 1.5, <code>.class</code> constructs are actually compiled differently,
 * using <code>Class.forName</code> constructs.
 *
 * @author Eric Lafortune
 */
public class DotClassClassVisitor implements InstructionVisitor, ConstantVisitor {
