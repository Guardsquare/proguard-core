 ...
 */
public class InitializerMethodFilter implements MemberVisitor {
   ...
   *
   * @param initializerMemberVisitor the member visitor to which visits to initializers will be
   *     delegated.
   */
   ...
   * @param initializerMemberVisitor the member visitor to which visits to initializers will be
   *     delegated.
   * @param otherMemberVisitor the member visitor to which visits to non-initializer methods will be
   *     delegated.
   */
  public InitializerMethodFilter(
      MemberVisitor initializerMemberVisitor, MemberVisitor otherMemberVisitor) {
  ...
  public void visitProgramMethod(ProgramClass programClass, ProgramMethod programMethod) {
    MemberVisitor memberVisitor = applicableMemberVisitor(programClass, programMethod);
  ...
  public void visitLibraryMethod(LibraryClass libraryClass, LibraryMethod libraryMethod) {
    MemberVisitor memberVisitor = applicableMemberVisitor(libraryClass, libraryMethod);
  ...
  /**
   * Returns the appropriate member visitor, depending on whether the given method is an initializer
   * or not.
   */
