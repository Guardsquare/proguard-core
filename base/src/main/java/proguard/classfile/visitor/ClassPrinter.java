...
/**
 * This {@link ClassVisitor} prints out the complete internal structure of the classes it visits.
 *
...
public class ClassPrinter
  ...
  public void visitLibraryClass(LibraryClass libraryClass) {
    ...
    println(
        "  = "
            ...
            + (libraryClass.getSuperName() == null
                ? ""
                : " extends " + ClassUtil.externalClassName(libraryClass.getSuperName())));
    outdent();
    println();
  ...
  public void visitPrimitiveArrayConstant(
    ...
    println(
        processingInfo(primitiveArrayConstant)
            + " PrimitiveArray "
  ...
  public void visitDynamicConstant(Clazz clazz, DynamicConstant dynamicConstant) {
    println(
        processingInfo(dynamicConstant)
  ...
  public void visitModulePackagesAttribute(
    ...
    println(
        processingInfo(modulePackagesAttribute)
            + " Module packages attribute (count = "
  ...
  public void visitMethodParametersAttribute(
    ...
    println(
        processingInfo(methodParametersAttribute)
            + " Method parameters attribute (count = "
  ...
  public void visitLineNumberTableAttribute(
    ...
    println(
        processingInfo(lineNumberTableAttribute)
  ...
  public void visitLocalVariableTableAttribute(
    ...
    println(
        processingInfo(localVariableTableAttribute)
  ...
  public void visitLocalVariableTypeTableAttribute(
    ...
    println(
        processingInfo(localVariableTypeTableAttribute)
  ...
  public void visitRuntimeVisibleAnnotationsAttribute(
    ...
    println(
        processingInfo(runtimeVisibleAnnotationsAttribute)
  ...
  public void visitRuntimeInvisibleAnnotationsAttribute(
    ...
    println(
        processingInfo(runtimeInvisibleAnnotationsAttribute)
  ...
  public void visitTableSwitchInstruction(
    ...
    for (int index = 0; index < jumpOffsets.length; index++) {
      ...
      println(
          Integer.toString(tableSwitchInstruction.lowCase + index)
              + ": offset = "
              + jumpOffset
              + ", target = "
              + (offset + jumpOffset));
  ...
  public void visitMoreZeroFrame(
    ...
    print(processingInfo(moreZeroFrame) + " [" + offset + "]" + " Var: ...");
  ...
  public void visitFullFrame(
    ...
    print(processingInfo(fullFrame) + " [" + offset + "]" + " Var: ");
  ...
  public void visitFloatType(
      Clazz clazz, Method method, CodeAttribute codeAttribute, int offset, FloatType floatType) {
    pw.print("[f]");
  }

  public void visitLongType(
      Clazz clazz, Method method, CodeAttribute codeAttribute, int offset, LongType longType) {
    pw.print("[l]");
  }

  public void visitDoubleType(
      Clazz clazz, Method method, CodeAttribute codeAttribute, int offset, DoubleType doubleType) {
    pw.print("[d]");
  }

  public void visitTopType(
      Clazz clazz, Method method, CodeAttribute codeAttribute, int offset, TopType topType) {
    pw.print("[T]");
  }
  ...
  public void visitNullType(
      Clazz clazz, Method method, CodeAttribute codeAttribute, int offset, NullType nullType) {
    pw.print("[n]");
  }
  ...
  public void visitUninitializedThisType(
      Clazz clazz,
      Method method,
      CodeAttribute codeAttribute,
      int offset,
  ...
  public void visitParameterInfo(
    ...
    println(
        "p"
            + parameterIndex
            + ":  Access flags: 0x"
            + Integer.toHexString(parameterInfo.u2accessFlags)
            + " = "
  ...
  public void visitTypeAnnotation(Clazz clazz, TypeAnnotation typeAnnotation) {
    println(
        processingInfo(typeAnnotation)
            + " Type annotation ["
            + typeAnnotation.getType(clazz)
            + "]:");
  ...
  public void visitTypeParameterTargetInfo(
    ...
    println(
        "Target (type = 0x"
            + Integer.toHexString(typeParameterTargetInfo.u1targetType)
            + "): Parameter #"
  ...
  public void visitSuperTypeTargetInfo(
    ...
    println(
        "Target (type = 0x"
            + Integer.toHexString(superTypeTargetInfo.u1targetType)
            + "): "
  ...
  public void visitTypeParameterBoundTargetInfo(
    ...
    println(
        "Target (type = 0x"
            + Integer.toHexString(typeParameterBoundTargetInfo.u1targetType)
            + "): parameter #"
  ...
  public void visitFormalParameterTargetInfo(
    ...
    println(
        "Target (type = 0x"
            + Integer.toHexString(formalParameterTargetInfo.u1targetType)
            + "): formal parameter #"
  ...
  public void visitThrowsTargetInfo(
    ...
    println(
        "Target (type = 0x"
            + Integer.toHexString(throwsTargetInfo.u1targetType)
            + "): throws #"
  ...
  public void visitLocalVariableTargetInfo(
    ...
    println(
        "Target (type = 0x"
            + Integer.toHexString(localVariableTargetInfo.u1targetType)
  ...
  public void visitCatchTargetInfo(
    ...
    println(
        "Target (type = 0x"
            + Integer.toHexString(catchTargetInfo.u1targetType)
            + "): catch #"
  ...
  public void visitOffsetTargetInfo(
    ...
    println(
        "Target (type = 0x"
            + Integer.toHexString(offsetTargetInfo.u1targetType)
            + "): offset "
  ...
  public void visitTypeArgumentTargetInfo(
    ...
    println(
        "Target (type = 0x"
            + Integer.toHexString(typeArgumentTargetInfo.u1targetType)
            + "): offset "
