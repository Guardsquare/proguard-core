 ...
 * ConstantVisitor}, except for classes that extend or implement a given class. This exception
 * includes the class itself.
 *
 * @author Eric Lafortune
 */
public class ImplementedClassConstantFilter implements ConstantVisitor {
   ...
   *
   * @param implementedClass the class whose implementations will not be visited.
  ...
  public void visitClassConstant(Clazz clazz, ClassConstant classConstant) {
    ...
    if (referencedClass == null || !referencedClass.extendsOrImplements(implementedClass)) {
