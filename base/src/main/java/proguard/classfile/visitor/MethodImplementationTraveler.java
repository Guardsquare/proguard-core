...
/**
 * This {@link MemberVisitor} lets a given {@link MemberVisitor} travel to all concrete and abstract
 * implementations of the visited methods in their class hierarchies.
 *
 * @author Eric Lafortune
 */
public class MethodImplementationTraveler implements MemberVisitor {
   ...
   *
   * @param visitThisMethod specifies whether to visit the originally visited methods.
   * @param visitSuperMethods specifies whether to visit the method in the super classes.
   * @param visitInterfaceMethods specifies whether to visit the method in the interface classes.
   * @param visitOverridingMethods specifies whether to visit the method in the subclasses.
   * @param memberVisitor the <code>MemberVisitor</code> to which visits will be delegated.
   */
  public MethodImplementationTraveler(
      ...
      programClass.hierarchyAccept(
          ...
          new NamedMethodVisitor(
              ...
              new MemberAccessFilter(
                  0, AccessConstants.PRIVATE | AccessConstants.STATIC, memberVisitor)));
    }
  }
  ...
  private boolean isSpecial(Clazz clazz, Method method) {
    return (method.getAccessFlags() & (AccessConstants.PRIVATE | AccessConstants.STATIC)) != 0
