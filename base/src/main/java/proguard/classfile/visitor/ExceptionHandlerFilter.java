...
/**
 * This {@link ExceptionInfoVisitor} delegates its visits to another given {@link
 * ExceptionInfoVisitor}, but only when the visited exception targets an instruction in the given
 * range of offsets.
 *
 * @author Eric Lafortune
 */
public class ExceptionHandlerFilter implements ExceptionInfoVisitor {
   ...
   * @param exceptionInfoVisitor the ExceptionInfoVisitor to which visits will be delegated.
   */
  public ExceptionHandlerFilter(
      int startOffset, int endOffset, ExceptionInfoVisitor exceptionInfoVisitor) {
  ...
  public void visitExceptionInfo(
    ...
    if (handlerPC >= startOffset && handlerPC < endOffset) {
