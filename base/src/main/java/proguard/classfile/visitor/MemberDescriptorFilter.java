...
public class MemberDescriptorFilter implements MemberVisitor {
   ...
   *
   * @param regularExpression the regular expression against which member descriptors will be
   *     matched.
   ...
   * Creates a new MemberDescriptorFilter.
   *
   * @param regularExpressionMatcher the regular expression against which member descriptors will be
   *     matched.
   * @param memberVisitor the <code>MemberVisitor</code> to which visits will be delegated.
   */
  public MemberDescriptorFilter(
      StringMatcher regularExpressionMatcher, MemberVisitor memberVisitor) {
