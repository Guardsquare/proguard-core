...
public class TableSwitchInstruction extends SwitchInstruction {
  ...
  /**
   * Creates a new TableSwitchInstruction with the given arguments. All offsets are relative to this
   * instruction's offset.
   */
  public TableSwitchInstruction(
      byte opcode, int defaultOffset, int lowCase, int highCase, int[] jumpOffsets) {
    this.opcode = opcode;
  ...
  public boolean equals(Object o) {
    ...
    return lowCase == that.lowCase && highCase == that.highCase;
  }
