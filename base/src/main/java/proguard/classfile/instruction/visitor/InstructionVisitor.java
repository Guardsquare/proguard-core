...
/**
 * This interface specifies the methods for a visitor of {@link Instruction} instances.
 *
 * @author Eric Lafortune
 */
public interface InstructionVisitor {
  /**
   * Visits any Instruction instance. The more specific default implementations of this interface
   * delegate to this method.
   */
  default void visitAnyInstruction(
      Clazz clazz,
      Method method,
    ...
    throw new UnsupportedOperationException(
        this.getClass().getName() + " does not support " + instruction.getClass().getName());
  }

  default void visitSimpleInstruction(
      Clazz clazz,
      Method method,
      CodeAttribute codeAttribute,
      int offset,
  ...
  default void visitVariableInstruction(
      Clazz clazz,
      Method method,
      CodeAttribute codeAttribute,
      int offset,
  ...
  default void visitConstantInstruction(
      Clazz clazz,
      Method method,
      CodeAttribute codeAttribute,
      int offset,
  ...
  default void visitBranchInstruction(
      Clazz clazz,
      Method method,
      CodeAttribute codeAttribute,
      int offset,
  ...
  /**
   * Visits any SwitchInstruction instance. The more specific default implementations of this
   * interface delegate to this method.
   */
  default void visitAnySwitchInstruction(
      Clazz clazz,
      Method method,
      CodeAttribute codeAttribute,
      int offset,
  ...
  default void visitTableSwitchInstruction(
      Clazz clazz,
      Method method,
      CodeAttribute codeAttribute,
      int offset,
  ...
  default void visitLookUpSwitchInstruction(
      Clazz clazz,
      Method method,
      CodeAttribute codeAttribute,
      int offset,
