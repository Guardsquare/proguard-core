...
/**
 * This utility class renders {@link Constant} objects into a more human-readable format. It can be
...
public class ConstantViewModel extends ProcessableViewModel {
  ...
  /**
   * A utility method that renders a {@link Constant} entry into a preview string, e.g., String(18)
   * -> "Foo".
   *
