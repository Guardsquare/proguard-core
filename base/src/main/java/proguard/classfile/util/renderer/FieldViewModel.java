...
/**
 * This utility class renders {@link Field} objects into a more human-readable format. It can be
...
public class FieldViewModel extends MemberViewModel {
  ...
  /**
   * A utility method that renders a {@link Field} entry into a preview string, e.g., "public static
   * int bar"
   *
   * @return A string previewing the constant pool entry.
   */
  public String renderPreview() {
    return ClassUtil.externalFullFieldDescription(
