...
public interface InjectStrategy {
     ...
     * @return An InjectLocation instance indicating an offset suitable for injection and whether the injection shall
     *         happen before or after the offset.
     */
     ...
     * @param targetClass The class holding the method in which a method invocation shall be injected into.
     * @param targetMethod the target method to have a method invocation injected into.
     * @return An array of InjectLocation instances indicating offsets suitable for injection and whether the injection
     *         shall take place before or after each offset.
     */
    InjectLocation[] getAllSuitableInjectionLocation(ProgramClass targetClass, ProgramMethod targetMethod);
    ...
    class InjectLocation {
        ...
        // Indicate whether an invocation instruction shall be injected before an offset specified in the offset field.
