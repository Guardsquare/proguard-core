...
/**
 * This {@link ClassVisitor} links all corresponding non-private, non-static, non-initializer
...
public class MethodLinker implements ClassVisitor, MemberVisitor {
  ...
  public void visitAnyClass(Clazz clazz) {
    ...
    clazz.hierarchyAccept(
        ...
        new AllMethodVisitor(
            new MemberAccessFilter(0, AccessConstants.PRIVATE | AccessConstants.STATIC, this)));

    // Link all the methods in the MultiFileFacades with their implementations in the corresponding
    // MultiFilePart.
  ...
  private static class KotlinMultiFileFacadeMethodLinker
      implements KotlinMetadataVisitor, MemberVisitor, ConstantVisitor {
    ...
    public void visitAnyMember(Clazz clazz, Member member) {
      ...
      multiFileFacadeMember.accept(
          clazz,
          new AllAttributeVisitor(
              new AllInstructionVisitor(
                  new InstructionOpCodeFilter(
                      new int[] {OP_INVOKESTATIC}, new InstructionConstantVisitor(this)))));
    }
