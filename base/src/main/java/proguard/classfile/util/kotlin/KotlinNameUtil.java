 ...
 *
 * <p>See, for example,
 * https://github.com/JetBrains/kotlin/blob/master/core/descriptors.jvm/src/org/jetbrains/kotlin/load/java/JvmAbi.java
 *
...
public class KotlinNameUtil {
  ...
  public static String generateSetterName(String name) {
    return prefixName(
        SET_PREFIX, startsWithIsPrefix(name) ? name.substring(IS_PREFIX.length()) : name);
  }
   ...
   * <p>For example:
   *
   * <p>getMyProperty -> myProperty isProperty -> property isfalse -> isfalse
   *
