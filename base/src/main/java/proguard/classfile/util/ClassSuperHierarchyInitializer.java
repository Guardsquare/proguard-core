...
public class ClassSuperHierarchyInitializer implements ClassVisitor, ConstantVisitor {
  ...
  public void visitLibraryClass(LibraryClass libraryClass) {
    ...
    if (libraryClass.interfaceNames != null) {
      ...
      for (int index = 0; index < interfaceNames.length; index++) {
        ...
        interfaceClasses[index] = findClass(className, interfaceNames[index]);
      }
  ...
  public void visitClassConstant(Clazz clazz, ClassConstant classConstant) {
    classConstant.referencedClass = findClass(clazz.getName(), classConstant.getName(clazz));
  }
  ...
  private Clazz findClass(String referencingClassName, String name) {
    ...
    if (clazz == null) {
      ...
      if (clazz == null && missingWarningPrinter != null) {
