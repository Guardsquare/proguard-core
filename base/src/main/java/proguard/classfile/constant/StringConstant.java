...
public class StringConstant extends Constant {
   ...
   * Class.forName(), .class, or Class.getDeclaredField/Method constructs. This field is typically
   ...
   * Class.getDeclaredField/Method constructs. This field is typically filled out by the <code>
   * {@link
   * proguard.classfile.util.DynamicMemberReferenceInitializer
   * DynamicMemberReferenceInitializer}</code>.
   */
  ...
  /**
   * An extra field pointing to the java.lang.String Clazz object. This field is typically filled
   * out by the <code>{@link
   ...
   * resource. Limitation: a String may point to multiple resources with the same name but a
   * different type - only one can be cached.
   */
  ...
  public boolean equals(Object object) {
    ...
    return this.u2stringIndex == other.u2stringIndex
  ...
  @Override
  public int hashCode() {
    return Constant.STRING ^ (u2stringIndex << 5);
  }
