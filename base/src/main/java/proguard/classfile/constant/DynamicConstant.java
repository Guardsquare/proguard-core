...
public class DynamicConstant extends Constant {
   ...
   *
   * @param u2bootstrapMethodAttributeIndex the index of the bootstrap method entry in the bootstrap
   *     methods attribute.
   * @param u2nameAndTypeIndex the index of the name and type entry in the constant pool.
   * @param referencedClasses the classes referenced by the type.
   */
  public DynamicConstant(
      int u2bootstrapMethodAttributeIndex, int u2nameAndTypeIndex, Clazz[] referencedClasses) {
  ...
  public boolean equals(Object object) {
    ...
    return this.u2bootstrapMethodAttributeIndex == other.u2bootstrapMethodAttributeIndex
        && this.u2nameAndTypeIndex == other.u2nameAndTypeIndex;
  }

  @Override
  public int hashCode() {
    return Constant.DYNAMIC ^ (u2bootstrapMethodAttributeIndex << 5) ^ (u2nameAndTypeIndex << 16);
  }

  @Override
  public String toString() {
    return "Dynamic(" + u2bootstrapMethodAttributeIndex + "," + u2nameAndTypeIndex + ")";
  }
}
