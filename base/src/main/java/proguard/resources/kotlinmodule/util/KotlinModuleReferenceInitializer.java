...
public class KotlinModuleReferenceInitializer
    implements ResourceFileVisitor, KotlinModulePackageVisitor {
  ...
  public void visitKotlinModulePackage(
      KotlinModule kotlinModule, KotlinModulePackage modulePackage) {
    ...
    modulePackage.multiFileClassParts.forEach(
        (multiFilePartName, multiFileFacadeName) -> {
          ...
          if (multiFilePartClass != null) {
            ...
            KotlinMultiFilePartKindMetadata kotlinMultiFilePartKindMetadata =
                finder.kotlinMultiFilePartKindMetadata;
            if (kotlinMultiFilePartKindMetadata != null) {
              kotlinMultiFilePartKindMetadata.referencedModule = kotlinModule;
              modulePackage.referencedMultiFileParts.put(
                  multiFilePartName, kotlinMultiFilePartKindMetadata);
            }
          }
        });
  }
