...
/**
 * Write a {@link KotlinModule} from a {@link ResourceFilePool} to the supplied {@link
 * DataEntryWriter}.
 *
...
public class KotlinModuleDataEntryWriter implements DataEntryWriter {
  ...
  public KotlinModuleDataEntryWriter(
      ResourceFilePool resourceFilePool, DataEntryWriter dataEntryWriter) {
  ...
  public OutputStream createOutputStream(DataEntry dataEntry) throws IOException {
    ...
    if (kotlinModule != null) {
      OutputStream outputStream =
          new BufferedOutputStream(dataEntryWriter.createOutputStream(dataEntry));
