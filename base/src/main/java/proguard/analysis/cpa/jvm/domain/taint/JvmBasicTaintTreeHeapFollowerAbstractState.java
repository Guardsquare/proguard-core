...
public class JvmBasicTaintTreeHeapFollowerAbstractState
   ...
   * @param objectMapAbstractStateFactory a map abstract state factory used for constructing the
   *     mapping from fields to values
   */
  public JvmBasicTaintTreeHeapFollowerAbstractState(
  ...
  @Override
  public JvmBasicTaintTreeHeapFollowerAbstractState join(
      JvmHeapAbstractState<SetAbstractState<JvmTaintSource>> abstractState) {
    JvmBasicTaintTreeHeapFollowerAbstractState other =
        (JvmBasicTaintTreeHeapFollowerAbstractState) abstractState;
    MapAbstractState<Reference, HeapNode<SetAbstractState<JvmTaintSource>>> newReferenceToNode =
    ...
    return new JvmBasicTaintTreeHeapFollowerAbstractState(
        principal,
        defaultValue,
        newReferenceToNode,
        heapMapAbstractStateFactory,
