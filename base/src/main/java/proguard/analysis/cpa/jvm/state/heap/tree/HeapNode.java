...
/**
 * The heap node represents an object or an array in the heap. The arrays do not distinguish between
 * different indices and consider all their elements to be aliased.
 *
 * @author Dmitry Ivanov
 */
public class HeapNode<StateT extends LatticeAbstractState<StateT>>
    implements Map<String, StateT>, LatticeAbstractState<HeapNode<StateT>> {
  ...
  public HeapNode<StateT> join(HeapNode<StateT> abstractState) {
    MapAbstractState<String, StateT> newFieldToAbstractState =
        fieldToAbstractState.join(abstractState.fieldToAbstractState);
