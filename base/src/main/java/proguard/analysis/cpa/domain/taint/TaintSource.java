  ...
  public String toString() {
    ...
    if (!taintsArgs.isEmpty()) {
      builder
          .append(", taints args (")
          .append(
              taintsArgs.stream().map(Object::toString).sorted().collect(Collectors.joining(", ")))
          .append(")");
    }
    if (!taintsGlobals.isEmpty()) {
      builder
          .append(", taints globals (")
          .append(taintsGlobals.stream().sorted().collect(Collectors.joining(", ")))
          .append(")");
    }
