...
/**
 * This {@link Variables} saves additional information with variables, to keep track of their
 * origins.
 *
 * <p>The class stores a given producer Value along with each Value it stores. It then generalizes a
 * given collected Value with the producer Value of each Value it loads. The producer Value and the
 * initial collected Value can be set; the generalized collected Value can be retrieved.
 *
