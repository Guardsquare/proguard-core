...
/**
 * This {@link LongValue} represents the result of a binary operation on two long values.
 *
...
public final class CompositeLongValue extends SpecificLongValue {
  ...
  public CompositeLongValue(LongValue longValue1, byte operation, Value longValue2) {
  ...
  public int hashCode() {
    return super.hashCode() ^ longValue1.hashCode() ^ longValue2.hashCode();
  }
