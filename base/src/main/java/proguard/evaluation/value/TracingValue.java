...
public class TracingValue extends Value {
  ...
  public final TracingValue generalize(TracingValue other) {
    return this.equals(other)
        ? this
        : new TracingValue(
            this.traceValue.generalize(other.traceValue), this.value.generalize(other.value));
  }
  ...
  public final Value generalize(Value other) {
    return other instanceof TracingValue
        ? generalize((TracingValue) other)
        : value.equals(other) ? this : new TracingValue(traceValue, value.generalize(other));
  }
  ...
  public boolean equals(Object object) {
    ...
    return this.traceValue.equals(other.traceValue) && this.value.equals(other.value);
  }

  public int hashCode() {
    return this.getClass().hashCode() ^ traceValue.hashCode() ^ value.hashCode();
  }
