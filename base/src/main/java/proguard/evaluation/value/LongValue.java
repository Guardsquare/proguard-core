...
public abstract class LongValue extends Category2Value {
  ...
  /** Returns the logical <i>and</i> of this LongValue and the given LongValue. */
  public LongValue and(LongValue other) {
    return other.and(this);
  }

  /** Returns the logical <i>or</i> of this LongValue and the given LongValue. */
  public LongValue or(LongValue other) {
    return other.or(this);
  }

  /** Returns the logical <i>xor</i> of this LongValue and the given LongValue. */
  ...
  /** Returns the logical <i>and</i> of this LongValue and the given SpecificLongValue. */
  public LongValue and(SpecificLongValue other) {
    return this;
  }

  /** Returns the logical <i>or</i> of this LongValue and the given SpecificLongValue. */
  public LongValue or(SpecificLongValue other) {
    return this;
  }

  /** Returns the logical <i>xor</i> of this LongValue and the given SpecificLongValue. */
  ...
  /** Returns the logical <i>and</i> of this LongValue and the given ParticularLongValue. */
  public LongValue and(ParticularLongValue other) {
    return and((SpecificLongValue) other);
  }

  /** Returns the logical <i>or</i> of this LongValue and the given ParticularLongValue. */
  public LongValue or(ParticularLongValue other) {
    return or((SpecificLongValue) other);
  }

  /** Returns the logical <i>xor</i> of this LongValue and the given ParticularLongValue. */
