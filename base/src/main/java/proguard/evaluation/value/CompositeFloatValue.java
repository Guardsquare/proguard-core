...
/**
 * This {@link FloatValue} represents the result of a binary operation on two float values.
 *
 * @author Eric Lafortune
 */
public final class CompositeFloatValue extends SpecificFloatValue {
  ...
  public CompositeFloatValue(FloatValue floatValue1, byte operation, FloatValue floatValue2) {
  ...
  public int hashCode() {
    return super.hashCode() ^ floatValue1.hashCode() ^ floatValue2.hashCode();
  }
