...
public abstract class IntegerValue extends Category1Value {
  ...
  public abstract IntegerValue multiply(IntegerValue other) throws ArithmeticException;

  /** Returns the quotient of this IntegerValue and the given IntegerValue. */
  public abstract IntegerValue divide(IntegerValue other) throws ArithmeticException;

  /** Returns the quotient of the given IntegerValue and this IntegerValue. */
  public abstract IntegerValue divideOf(IntegerValue other) throws ArithmeticException;

  /** Returns the remainder of this IntegerValue divided by the given IntegerValue. */
  public abstract IntegerValue remainder(IntegerValue other) throws ArithmeticException;

  /** Returns the remainder of the given IntegerValue divided by this IntegerValue. */
  public abstract IntegerValue remainderOf(IntegerValue other) throws ArithmeticException;
  ...
  /** Returns the logical <i>and</i> of this IntegerValue and the given IntegerValue. */
  public abstract IntegerValue and(IntegerValue other);

  /** Returns the logical <i>or</i> of this IntegerValue and the given IntegerValue. */
  public abstract IntegerValue or(IntegerValue other);

  /** Returns the logical <i>xor</i> of this IntegerValue and the given IntegerValue. */
  public abstract IntegerValue xor(IntegerValue other);

  /**
   * Returns whether this IntegerValue and the given IntegerValue are equal: <code>NEVER</code>,
   * <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  public abstract int equal(IntegerValue other);

  /**
   * Returns whether this IntegerValue is less than the given IntegerValue: <code>NEVER</code>,
   * <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  public abstract int lessThan(IntegerValue other);

  /**
   * Returns whether this IntegerValue is less than or equal to the given IntegerValue: <code>NEVER
   * </code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /**
   * Returns whether this IntegerValue and the given IntegerValue are different: <code>NEVER</code>,
   * <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /**
   * Returns whether this IntegerValue is greater than the given IntegerValue: <code>NEVER</code>,
   * <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /**
   * Returns whether this IntegerValue is greater than or equal to the given IntegerValue: <code>
   * NEVER</code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /** Returns the logical <i>and</i> of this IntegerValue and the given UnknownIntegerValue. */
  public IntegerValue and(UnknownIntegerValue other) {
    return and((IntegerValue) other);
  }

  /** Returns the logical <i>or</i> of this IntegerValue and the given UnknownIntegerValue. */
  public IntegerValue or(UnknownIntegerValue other) {
    return or((IntegerValue) other);
  }

  /** Returns the logical <i>xor</i> of this IntegerValue and the given UnknownIntegerValue. */
  public IntegerValue xor(UnknownIntegerValue other) {
    return xor((IntegerValue) other);
  }

  /**
   * Returns whether this IntegerValue and the given UnknownIntegerValue are equal: <code>NEVER
   * </code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /**
   * Returns whether this IntegerValue is less than the given UnknownIntegerValue: <code>NEVER
   * </code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /**
   * Returns whether this IntegerValue and the given UnknownIntegerValue are different: <code>NEVER
   * </code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /**
   * Returns whether this IntegerValue is greater than the given UnknownIntegerValue: <code>NEVER
   * </code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /** Returns the logical <i>and</i> of this IntegerValue and the given SpecificIntegerValue. */
  public IntegerValue and(SpecificIntegerValue other) {
    return and((IntegerValue) other);
  }

  /** Returns the logical <i>or</i> of this IntegerValue and the given SpecificIntegerValue. */
  public IntegerValue or(SpecificIntegerValue other) {
    return or((IntegerValue) other);
  }

  /** Returns the logical <i>xor</i> of this IntegerValue and the given SpecificIntegerValue. */
  public IntegerValue xor(SpecificIntegerValue other) {
    return xor((IntegerValue) other);
  }

  /**
   * Returns whether this IntegerValue and the given SpecificIntegerValue are equal: <code>NEVER
   * </code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /**
   * Returns whether this IntegerValue is less than the given SpecificIntegerValue: <code>NEVER
   * </code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /**
   * Returns whether this IntegerValue and the given SpecificIntegerValue are different: <code>NEVER
   * </code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /**
   * Returns whether this IntegerValue is greater than the given SpecificIntegerValue: <code>NEVER
   * </code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /** Returns the logical <i>and</i> of this IntegerValue and the given ParticularIntegerValue. */
  public IntegerValue and(ParticularIntegerValue other) {
    return and((SpecificIntegerValue) other);
  }

  /** Returns the logical <i>or</i> of this IntegerValue and the given ParticularIntegerValue. */
  public IntegerValue or(ParticularIntegerValue other) {
    return or((SpecificIntegerValue) other);
  }

  /** Returns the logical <i>xor</i> of this IntegerValue and the given ParticularIntegerValue. */
  public IntegerValue xor(ParticularIntegerValue other) {
    return xor((SpecificIntegerValue) other);
  }

  /**
   * Returns whether this IntegerValue and the given ParticularIntegerValue are equal: <code>NEVER
   * </code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /**
   * Returns whether this IntegerValue is less than the given ParticularIntegerValue: <code>NEVER
   * </code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /**
   * Returns whether this IntegerValue and the given ParticularIntegerValue are different: <code>
   * NEVER</code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /**
   * Returns whether this IntegerValue is greater than the given ParticularIntegerValue: <code>NEVER
   * </code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /** Returns the logical <i>and</i> of this IntegerValue and the given RangeIntegerValue. */
  public IntegerValue and(RangeIntegerValue other) {
    return and((IntegerValue) other);
  }

  /** Returns the logical <i>or</i> of this IntegerValue and the given RangeIntegerValue. */
  public IntegerValue or(RangeIntegerValue other) {
    return or((IntegerValue) other);
  }

  /** Returns the logical <i>xor</i> of this IntegerValue and the given RangeIntegerValue. */
  public IntegerValue xor(RangeIntegerValue other) {
    return xor((IntegerValue) other);
  }

  /**
   * Returns whether this IntegerValue and the given RangeIntegerValue are equal: <code>NEVER</code>
   * , <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /**
   * Returns whether this IntegerValue is less than the given RangeIntegerValue: <code>NEVER</code>,
   * <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /**
   * Returns whether this IntegerValue is less than or equal to the given RangeIntegerValue: <code>
   * NEVER</code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /**
   * Returns whether this IntegerValue and the given RangeIntegerValue are different: <code>NEVER
   * </code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
  ...
  /**
   * Returns whether this IntegerValue is greater than the given RangeIntegerValue: <code>NEVER
   * </code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
