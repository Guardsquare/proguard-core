...
public abstract class Value {
   ...
   *
   * @return <code>TYPE_INTEGER</code>, <code>TYPE_LONG</code>, <code>TYPE_FLOAT</code>, <code>
   *     TYPE_DOUBLE</code>, <code>TYPE_REFERENCE</code>, or <code>TYPE_INSTRUCTION_OFFSET</code>.
   */
   ...
   *     , <code>TypeConstants.LONG</code>, <code>TypeConstants.FLOAT</code>, <code>
   *     TypeConstants.DOUBLE</code>, <code>TypeConstants.CLASS_START ... TypeConstants.CLASS_END
   *     </code>, or an array type containing any of these types (always as String).
   */
