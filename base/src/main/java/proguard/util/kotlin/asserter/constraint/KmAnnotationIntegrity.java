  ...
  public void visitAnyKotlinMetadata(Clazz clazz, KotlinMetadata kotlinMetadata) {
    kotlinMetadata.accept(
        ...
        new MultiKotlinMetadataVisitor(
            new AllKotlinAnnotationVisitor(
                new KotlinAnnotationVisitor() {
                  public void visitAnyAnnotation(
                      Clazz clazz, KotlinAnnotatable annotatable, KotlinAnnotation annotation) {
                    util =
                        new AssertUtil(
                            "Kotlin annotation", reporter, programClassPool, libraryClassPool);
                    annotation.accept(clazz, annotatable, KmAnnotationIntegrity.this);
                  }
                }),
