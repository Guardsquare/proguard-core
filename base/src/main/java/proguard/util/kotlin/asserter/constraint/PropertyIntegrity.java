...
public class PropertyIntegrity extends AbstractKotlinMetadataConstraint
  ...
  public void visitAnyProperty(
    ...
    AssertUtil util =
        new AssertUtil(
            "Property " + kotlinPropertyMetadata.name,
            reporter,
            programClassPool,
            libraryClassPool);
    ...
    if (kotlinPropertyMetadata.setterMetadata.signature != null) {
