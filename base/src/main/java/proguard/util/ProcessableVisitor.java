...
public interface ProcessableVisitor
    extends ClassVisitor, MemberVisitor, AttributeVisitor, ResourceFileVisitor, ConstantVisitor {
  /**
   * Visits any Processable instance. The more specific default implementations of this interface
   * delegate to this method.
   */
  default void visitAnyProcessable(Processable processable) {
    throw new UnsupportedOperationException(
        this.getClass().getName() + " does not support " + processable.getClass().getName());
  }
