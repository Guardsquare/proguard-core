...
public class ProcessingFlags {
  ...
  public static final int DONT_OPTIMIZE =
      mask22; // Marks whether an entity should not be optimized.
  public static final int DONT_OBFUSCATE =
      mask23; // Marks whether an entity should not be obfuscated.
  ...
  public static final int DONT_SHRINK_OR_OPTIMIZE_OR_OBFUSCATE =
      DONT_SHRINK | DONT_OPTIMIZE | DONT_OBFUSCATE;

  // Internal processing flags.
  public static final int IS_CLASS_AVAILABLE =
      mask1; // Marks whether a class member can be used for generalization or specialization.
  public static final int REMOVED_FIELDS =
      mask3; // Marks whether a class has (at least one) fields removed.
  public static final int REMOVED_PUBLIC_FIELDS =
      mask4; // Marks whether a class has (at least one) public fields removed.
  public static final int REMOVED_CONSTRUCTORS =
      mask5; // Marks whether a class has (at least one) constructors removed.
  public static final int REMOVED_PUBLIC_CONSTRUCTORS =
      mask6; // Marks whether a class has (at least one) public constructors removed.
  public static final int REMOVED_METHODS =
      mask7; // Marks whether a class has (at least one) methods removed.
  public static final int REMOVED_PUBLIC_METHODS =
      mask8; // Marks whether a class has (at least one) public methods removed.
  ...
  public static final int DONT_PROCESS_KOTLIN_MODULE =
      mask16; // Marks whether to processing a Kotlin module file.
  public static final int MODIFIED = mask15; // Marks whether an entity has been modified.

  // A mask for processing flags that can be copied as well when e.g. inlining a method / merging a
  // class.
