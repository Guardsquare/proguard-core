...
/**
 * This {@link DataEntryReader} writes the resource data entries that it reads to a given {@link
 * DataEntryWriter}, updating their contents based on the renamed classes in the given {@link
 * ClassPool}.
 *
...
public class DataEntryRewriter extends DataEntryCopier {
  ...
  private String adaptedWord(String word) {
    ...
    String className = containsDots ? word.replace('.', TypeConstants.PACKAGE_SEPARATOR) : word;
