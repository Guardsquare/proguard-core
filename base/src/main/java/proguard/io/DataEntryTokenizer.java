...
/**
 * This class breaks up the character data read from a given Reader into {@link DataEntryToken}s. It
  ...
  public DataEntryToken nextToken() throws IOException {
    ...
    while (true) {
      ...
      if (tokenString.length() == 0
          || isJavaIdentifierChar(c) == isJavaIdentifierChar(tokenString.charAt(0))) {
