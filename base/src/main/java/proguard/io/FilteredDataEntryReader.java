...
public class FilteredDataEntryReader implements DataEntryReader {
   ...
   * @param acceptedDataEntryReader the DataEntryReader to which the reading will be delegated if
   *     the filter accepts the data entry. May be <code>null</code>.
   */
  public FilteredDataEntryReader(
      DataEntryFilter dataEntryFilter, DataEntryReader acceptedDataEntryReader) {
   ...
   * @param acceptedDataEntryReader the DataEntryReader to which the reading will be delegated if
   *     the filter accepts the data entry. May be <code>null</code>.
   * @param rejectedDataEntryReader the DataEntryReader to which the reading will be delegated if
  ...
  public void read(DataEntry dataEntry) throws IOException {
    DataEntryReader dataEntryReader =
        dataEntryFilter.accepts(dataEntry) ? acceptedDataEntryReader : rejectedDataEntryReader;
