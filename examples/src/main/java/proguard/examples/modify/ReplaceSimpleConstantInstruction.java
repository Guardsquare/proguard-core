...
/**
 * Example showing how to use {@link InstructionSequenceReplacer} to replace an `LDC` loading "Hello
...
public class ReplaceSimpleConstantInstruction {
  ...
  public static void main(String[] args)
    ...
    ProgramClass helloWorld =
        CreateHelloWorldClass.createMessagePrintingClass("HelloWorld", "Hello World");
    ...
    PeepholeEditor dutchTranslator =
        new PeepholeEditor(
            codeAttributeEditor,
    ...
    helloWorld.methodsAccept(
        new MemberNameFilter("main", new AllAttributeVisitor(dutchTranslator)));
