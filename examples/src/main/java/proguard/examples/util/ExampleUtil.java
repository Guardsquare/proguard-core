...
public class ExampleUtil {
  ...
  public static void addClass(ClassPool classPool, Class<?>... classes) {
    for (var clazz : classes) {
      var is =
          ExampleUtil.class
              .getClassLoader()
              .getResourceAsStream(internalClassName(clazz.getName()) + ".class");
      if (is == null) {
  ...
  /**
   * Execute the "main" method of a ProGuardCORE class in the given {@link ClassPool} with the
   * specified name.
   */
   ...
   */
  public static Object executeMainMethod(
      ClassPool classPool, String internalClassName, String... arguments) {
    try {
      return executeMethod(
          classPool, internalClassName, "main", new Class[] {String[].class}, arguments);
  ...
  /**
   * Execute the specified method of a ProGuardCORE class in the given {@link ClassPool} with the
   * specified name and the specified arguments.
   */
