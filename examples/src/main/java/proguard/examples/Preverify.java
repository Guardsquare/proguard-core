 ...
 *
 * <p>Usage: java proguard.examples.Preverify input.jar output.jar
 */
public class Preverify {
  ...
  /**
   * Preverifies the code of the classes in the given class pool, adding StackMapTable attributes to
