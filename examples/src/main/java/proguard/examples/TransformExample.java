  ...
  public static void main(String[] args) throws IOException {
    ...
    BiFunction<DataEntryReader, ClassVisitor, DataEntryReader> dexConverter =
        (dataEntryReader, classPoolFiller) ->
            new NameFilteredDataEntryReader(
                "classes*.dex", new DexClassReader(true, classPoolFiller), dataEntryReader);
    ...
    programClassPool.classesAccept(
        new ClassVersionFilter(
            ...
            new AllMethodVisitor(new AllAttributeVisitor(new CodePreverifier(false)))));
    ...
    DataEntryWriter writer =
        dataEntryWriterFactory.createDataEntryWriter(programJars, 1, programJars.size(), null);
          ...
          new NameFilteredDataEntryReader(
              ...
              dataEntry -> {
                ...
                for (Clazz programClass : classPool.classes()) {
                  finalClassReader.read(
                      new RenamedDataEntry(dataEntry, programClass.getName() + ".class"));
                }
              },
              classReader);
    }
    ...
    DataEntryReader reader =
        new DataEntryReaderFactory(android).createDataEntryReader(inputEntry, classReader);
  ...
  public static class MyTransformer implements ClassVisitor {
    ...
    public void visitProgramClass(ProgramClass programClass) {
      ...
      Instruction[][] replacements = {
        ____.ldc("Hello, world!").__(), ____.ldc("Hallo, wereld!").__()
      };
